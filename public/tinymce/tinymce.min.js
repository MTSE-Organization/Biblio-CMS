...
!(function () {
  ...
  const Pe = (e) => {
    ...
    Fe = Me((e, t) => t),
    Ue = (e, t, n = R) => e.exists((e) => n(e, t)),
    ze = (e, t, n = R) => je(e, t, n).getOr(e.isNone() && t.isNone()),
    je = (e, t, n) =>
      e.isSome() && t.isSome()
  ...
  const Ve = (e) => {
    ...
    Mt = Pt,
    It = (N(Rt), N(Dt), N('IE'), N(Tt), N(Ot), N(Bt), 'Windows'),
    Ft = 'Android',
    Ut = 'Linux',
    zt = 'macOS',
    jt = 'Solaris',
  ...
  const hn = (e, t) => {
    ...
    Lo = (e) => {
      const t = An(e) ? e.dom.parentNode : e.dom;
  ...
  const ks = (e, t, n, o) =>
    ...
    Rs = (e, t, n) => As(e, t.dom, { checkRootAsContent: !0, ...n }),
              ...
              rr(t, s, a).each((n) => {
                ((e, t, n) => {
                  ...
                  if (r) {
                    ...
                    (zs(e, a, !1),
                      As(e, s, { checkRootAsContent: !0 }) ||
                        r.insertBefore(s, t),
                      As(e, n, { checkRootAsContent: !0 }) ||
                        r.insertBefore(n, t),
                      As(e, a, { checkRootAsContent: !0 }) ||
                        r.insertBefore(a, t),
                      r.removeChild(t));
                  }
                })(e, n.dom, t.dom);
    ...
    Pa = (e = {}) => {
      ...
      const c = Ba(e.valid_styles),
        ...
        R = i('transparent_elements', 'a ins del canvas map'),
      ...
      return (
        e.valid_elements
          ...
          : (Aa(d, (e, t) => {
            ...
            Aa(va('ol ul blockquote a table tbody'), (e) => {
        ...
        F = (e, t) =>
          O(e, (e) => {
            ...
            return (
              t &&
                q(Hn(n), (e) => {
                  An(e) && 0 === e.dom.length ? _o(e) : io(n, e);
                }),
              _o(n),
              n.dom
            );
  ...
  const hi = N('mce-annotation'),
    ...
    Oi = Ri(['ul', 'ol', 'dl']),
    Bi = Ri(['li', 'dd', 'dt']),
    Pi = Ri(['thead', 'tbody', 'tfoot']),
    Li = Ri(['td', 'th']),
    Mi = Ri(['pre', 'script', 'textarea', 'style']),
    Ii = () => {
    ...
    Ul = (e, t, n) => {
        ...
        n ||
          (n = ((e) => {
            const t = [],
              ...
              r = e.container(),
              s = e.offset();
            if (Al(r)) return (o(r, s), t);
            if (El(r))
              if (e.isAtEnd()) {
                const e = Tl(r, s);
                (Al(e) && o(e, e.data.length),
                  kl(e) && !Rl(e) && n(Fl(Il(e), !1)));
              } else {
                const a = Tl(r, s);
      ...
      return {
        ...
        isAtStart: () => (Al(e), 0 === t),
        isAtEnd: () => (Al(e) ? t >= e.data.length : t >= e.childNodes.length),
  ...
  const zl = (e, t) => {
    ...
    ad = D(od, A, !0),
    id = (e) => 'inline-command' === e.type || 'inline-format' === e.type,
    ld = (e) => 'block-command' === e.type || 'block-format' === e.type,
    dd = (e) => {
      var t;
    ...
    bd = (e, t) => e.dispatch('SetContent', t),
    vd = (e, t) => e.dispatch('GetContent', t),
    yd = (e, t) => {
      e.dispatch('AutocompleterUpdateActiveRange', t);
    },
    Cd = (e, t) => e.dispatch('PastePlainTextToggle', { state: t }),
    wd = Gt().deviceType,
    Ed = wd.isTouch(),
    xd = li.DOM,
    Sd = (e) => m(e, RegExp),
    _d = (e) => (t) => t.options.get(e),
    kd = (e) => u(e) || f(e),
    Nd =
      (e, t = '') =>
      (n) => {
    ...
    Ad = _d('iframe_attrs'),
    Rd = _d('doctype'),
    Dd = _d('document_base_url'),
    Td = _d('body_id'),
    Od = _d('body_class'),
    Bd = _d('content_security_policy'),
    Pd = _d('br_in_pre'),
    Ld = _d('forced_root_block'),
    Md = _d('forced_root_block_attrs'),
    Id = _d('newline_behavior'),
    Fd = _d('br_newline_selector'),
    Ud = _d('no_newline_selector'),
    zd = _d('keep_styles'),
    jd = _d('end_container_on_empty_block'),
    $d = _d('automatic_uploads'),
    Hd = _d('images_reuse_filename'),
    Vd = _d('images_replace_blob_uris'),
    qd = _d('icons'),
    Wd = _d('icons_url'),
    Kd = _d('images_upload_url'),
    Yd = _d('images_upload_base_path'),
    Gd = _d('images_upload_credentials'),
    Xd = _d('images_upload_handler'),
    Qd = _d('content_css_cors'),
    Zd = _d('referrer_policy'),
    Jd = _d('crossorigin'),
    ec = _d('language'),
    tc = _d('language_url'),
    nc = _d('indent_use_margin'),
    oc = _d('indentation'),
    rc = _d('content_css'),
    sc = _d('content_style'),
    ac = _d('font_css'),
    ic = _d('directionality'),
    lc = _d('inline_boundaries_selector'),
    dc = _d('object_resizing'),
    cc = _d('resize_img_proportional'),
    mc = _d('placeholder'),
    uc = _d('event_root'),
    fc = _d('service_message'),
    gc = _d('theme'),
    pc = _d('theme_url'),
    hc = _d('model'),
    bc = _d('model_url'),
    vc = _d('inline_boundaries'),
    yc = _d('formats'),
    Cc = _d('preview_styles'),
    wc = _d('format_empty_lines'),
    Ec = _d('format_noneditable_selector'),
    xc = _d('custom_ui_selector'),
    Sc = _d('inline'),
    _c = _d('hidden_input'),
    kc = _d('submit_patch'),
    Nc = _d('add_form_submit_trigger'),
    Ac = _d('add_unload_trigger'),
    Rc = _d('custom_undo_redo_levels'),
    Dc = _d('disable_nodechange'),
    Tc = _d('readonly'),
    Oc = _d('editable_root'),
    Bc = _d('content_css_cors'),
    Pc = _d('plugins'),
    Lc = _d('external_plugins'),
    Mc = _d('block_unsupported_drop'),
    Ic = _d('visual'),
    Fc = _d('visual_table_class'),
    Uc = _d('visual_anchor_class'),
    zc = _d('iframe_aria_text'),
    jc = _d('setup'),
    $c = _d('init_instance_callback'),
    Hc = _d('urlconverter_callback'),
    Vc = _d('auto_focus'),
    qc = _d('browser_spellcheck'),
    Wc = _d('protect'),
    Kc = _d('paste_block_drop'),
    Yc = _d('paste_data_images'),
    Gc = _d('paste_preprocess'),
    Xc = _d('paste_postprocess'),
    Qc = _d('newdocument_content'),
    Zc = _d('paste_webkit_styles'),
    Jc = _d('paste_remove_styles_if_webkit'),
    em = _d('paste_merge_formats'),
    tm = _d('smart_paste'),
    nm = _d('paste_as_text'),
    om = _d('paste_tab_spaces'),
    rm = _d('allow_html_data_urls'),
    sm = _d('text_patterns'),
    am = _d('text_patterns_lookup'),
    im = _d('noneditable_class'),
    lm = _d('editable_class'),
    dm = _d('noneditable_regexp'),
    cm = _d('preserve_cdata'),
    mm = _d('highlight_on_focus'),
    um = _d('xss_sanitization'),
    fm = _d('init_content_sync'),
    gm = (e) => dn.explode(e.options.get('images_file_types')),
    pm = _d('table_tab_navigation'),
    hm = _d('details_initial_state'),
    bm = _d('details_serialized_state'),
    vm = _d('sandbox_iframes'),
    ym = (e) => e.options.get('sandbox_iframes_exclusions'),
    Cm = _d('convert_unsafe_embeds'),
    wm = _d('license_key'),
    Em = _d('api_key'),
    xm = _d('disabled'),
    Sm = _d('user_id'),
    _m = _d('fetch_users'),
    km = _d('lists_indent_on_tab'),
    Nm = (e) => I.from(e.options.get('list_max_depth')),
    Am = Xr,
    Rm = ss,
    Dm = (e) => {
      const t = e.parentNode;
    ...
    Pm = (e, t) =>
      Ul.isTextPosition(t)
        ? ((e, t) =>
            Rm(e) && t.container() === e
              ? ((e, t) => {
                  const n = Tm(e.data.substr(0, t.offset())),
                    o = Tm(e.data.substr(t.offset()));
                  return (n.text + o.text).length > 0
                    ? (Om(e), Ul(e, t.offset() - n.count))
                    : t;
                })(e, t)
              : Bm(e, t))(e, t)
        : ((e, t) =>
            t.container() === e.parentNode
              ...
              : Bm(e, t))(e, t),
    Lm = (e) => {
      (Am(e) && Wi(e) && (Ki(e) ? e.removeAttribute('data-mce-caret') : Dm(e)),
        Rm(e) && (Om(e), 0 === e.data.length && Dm(e)));
    },
    Mm = ps,
    Im = Cs,
    Fm = bs,
    ...
    zm = (e, t, n, o) => {
      ...
      return {
        ...
        reposition: () => {
          r.on((e) => {
            const n = Um(t, e.element, e.before);
    ...
    jm = () => rn.browser.isFirefox(),
    $m = (e) => Mm(e) || Im(e),
    Hm = (e) => ($m(e) || (ns(e) && jm())) && Mn(mn.fromDom(e)).exists(vr),
    Vm = gs,
    qm = ps,
    Wm = Cs,
    Km = es(
    ...
    su = (e, t) => {
      ...
      const n = t.container(),
        o = t.offset();
      return Xm(n) ? I.from(n.childNodes[o + e]) : I.none();
    },
    au = (e, t) => {
      var n;
      const o = (
    ...
    mu = (e, t, n) => {
      ...
      const r = D(lu, !0, t),
        ...
        i = n.startOffset;
      if (Vi(a)) {
        const e = Qm(a) ? a.parentNode : a,
          t = e.getAttribute('data-mce-caret');
        if ('before' === t && ((o = e.nextSibling), Hm(o))) return du(o);
        if ('after' === t && ((o = e.previousSibling), Hm(o))) return cu(o);
      }
    ...
    _u = (e, t) => {
      ...
      return eu(e) ? (Cu(t) ? Ul.before(t) : Ul.after(t)) : Ul.before(t);
    },
    ku = (e, t, n) => {
      let o, r, s, a;
      ...
      if (t.isEqual(Ul.after(n)) && n.lastChild) {
        if (
          ...
          eu(e) && wu(n.lastChild) && yu(n.lastChild))
        )
      ...
      let l = a.offset();
      if (vu(i)) {
        if (eu(e) && l > 0) return Ul(i, --l);
        if (Jm(e) && l < i.length) return Ul(i, ++l);
        o = i;
      } else {
      ...
      if (
        o &&
        ((Jm(e) && a.isAtEnd()) || (eu(e) && a.isAtStart())) &&
      ...
      return !d || (r && d.contains(r))
        ? r
          ? _u(e, r)
          : null
        : ((a = Jm(e) ? Ul.after(d) : Ul.before(d)), a);
    },
    Nu = (e) => ({ next: (t) => ku(1, t, e), prev: (t) => ku(-1, t, e) }),
    Au = (e) => (Ul.isTextPosition(e) ? 0 === e.offset() : yl(e.getNode())),
    Ru = (e) => {
  ...
  const ig = (e, t, n) =>
    ...
    lg = (e, t) => {
      const n = An(t) ? er(t).length : Hn(t).length + 1;
      ...
      const E = (e) => C(e) && (us(e) || n.is(e, 'figure.image')),
        ...
        D = () => {
          ...
          ((h = !1),
            ...
            n.unbind(o, 'mousemove', R),
            n.unbind(o, 'mouseup', D),
            r !== o && (n.unbind(r, 'mousemove', R), n.unbind(r, 'mouseup', D)),
            n.remove(i),
            n.remove(l),
            n.remove(c),
            T(a),
                    ...
                    (h.stopImmediatePropagation(),
                      ...
                      ((h) => {
                        ...
                        ((m = h.screenX),
                          ...
                          s.appendChild(i),
                          n.bind(o, 'mousemove', R),
                          n.bind(o, 'mouseup', D),
                          r !== o &&
                            (n.bind(r, 'mousemove', R),
                            n.bind(r, 'mouseup', D)),
                          (l = n.add(
                            s,
                            'div',
  ...
  const Sp = dn.makeMap(
    ...
    Rp = (e) => null !== Np(e).nextNode(),
    Dp = (e) => null !== Ap(e).nextNode(),
  ...
  const qp = ['font', 'text-decoration', 'text-emphasis'],
    ...
    Dh = (e, t) => (n) => {
      return ((o = new Hr(n, e)[t]()), C(o) && ps(o) && Km(o));
      var o;
    },
    Th = (e, t, n) =>
      !Rh(t) &&
        ...
        e
          ? ((e, t) =>
              Wh(t)
                ...
                .orThunk(() =>
                  ((e, t) =>
                    Lu(e, Ul.after(t)).orThunk(() => Mu(e, Ul.before(t))))(e, t)
                ))(t, n)
          : ((e, t) =>
              qh(t)
                .orThunk(() => Wh(t))
    ...
    Qh = /[\u0591-\u07FF\uFB1D-\uFDFF\uFE70-\uFEFC]/,
    Zh = (e, t) =>
      hn(mn.fromDom(t), lc(e)) && !Ks(e.schema, t) && e.dom.isEditable(t),
    Jh = (e) => {
      var t;
      return (
    ...
    ub = (e, t, n, o = !0) => {
      ...
      if (
        (a.dom === e.getBody()
          ? db(e, o)
          : Rs(e.schema, a, { checkRootAsContent: !1 }) &&
            (Fi(a), o && e.selection.setCursorLocation(a.dom, 0)),
        !vn(n, a))
      ) {
        const t = Ue(Ln(a), n) ? [] : Fn(a);
        q(t.concat(Hn(n)), (t) => {
          vn(t, a) || yn(t, a) || !Rs(e.schema, t) || _o(t);
        });
      }
    },
    fb = (e) => xr(e, 'td,th'),
    ...
    Db = (e, t, n, o) =>
      I.some(() => {
        ...
        const i = Rs(e.schema, s) ? t : t.slice(1),
          l = Rs(e.schema, a) ? n : n.slice(0, -1);
        (kb(i.concat(l)), o.deleteContents(), Ab(e));
      }),
    Tb = (e, t, n, o = !0) =>
      I.some(() => {
        ub(e, t, n, o);
        ...
        () =>
          ((e, t, n, o) => {
            ...
            return Bb(n, o).bind((o) =>
              Rs(e.schema, o, { checkRootAsContent: !1 })
                ? Lb(e, o)
                : ((e, t, n, o, r) =>
              ...
              : ((e, t, n, o) =>
                  Pb(t, o).fold(
                    () =>
                      ((e, t, n) =>
                        _b(t, n).bind((t) =>
                          t.fold(D(Tb, e), D(Ob, e), D(Rb, e), D(Db, e))
                        ))(e, t, n),
                    (t) => ((e, t) => Lb(e, t))(e, t)
                  ))(e, o, r, t);
          })(e, n, o);
    ...
    Gb = (e, t, n, o, r) => {
      ...
      const a = e.dom.getParent(
        t,
        (t) => !!Yb(e, t, n) || t.parentNode === s || !!Zb(e, t, n, o, !0)
      );
      return !!Zb(e, a, n, o, r);
    },
    Xb = (e, t, n) =>
      ...
      if (a)
        if (ut(a)) {
          for (let n = 0; n < a.length; n++)
            if (i ? e.getAttrib(t, a[n]) : Rf(e, t, a[n])) return !0;
        } else
          for (const o in a)
            if (Se(a, o)) {
              const l = i ? e.getAttrib(t, o) : Rf(e, t, o),
                d = kf(a[o], s),
                c = y(l) || ot(l);
              if (c && y(d)) continue;
              if (r && c && !n.exact) return !1;
              if ((!r || n.exact) && !Kb(l, Af(d, o))) return !1;
            }
      return !0;
    },
    Zb = (e, t, n, o, r) => {
    ...
    Jb = (e, t, n, o, r) => {
      if (o) return Gb(e, o, t, n, r);
      if (((o = e.selection.getNode()), Gb(e, o, t, n, r))) return !0;
      const s = e.selection.getStart();
      return !(s === o || !Gb(e, s, t, n, r));
    },
    ev = Ui,
    tv = (e) => {
      if (e) {
    ...
    ov = (e, t, n) => {
      ...
      if (If(t)) Xh(e, !1, mn.fromDom(t), n, !0);
        ...
        const e = r.getRng(),
          ...
          d = ((e) => {
            const t = tv(e);
            return (t && t.data.charAt(0) === ev && t.deleteData(0, 1), t);
          })(t);
        (o.remove(t, !0),
    ...
    rv = (e, t, n) => {
      ...
      if (t) ov(e, t, n);
        ...
        for (; (t = o.get(Uu)); ) ov(e, t, n);
    },
    sv = (e, t) => (e.appendChild(t), t),
    av = (e, t) => {
      var n;
      const o = G(e, (e, t) => sv(e, t.cloneNode(!1)), t),
        r = null !== (n = o.ownerDocument) && void 0 !== n ? n : document;
      return sv(o, r.createTextNode(ev));
    },
    iv = (e) => tr(e, er(e).replace(new RegExp(`${dt}$`), ' ')),
    lv = (e, t) => {
      const n = () => {
        null === t ||
          e.dom.isEmpty(t) ||
    ...
    mv = (e, t) => {
      const { caretContainer: n, caretPosition: o } = cv(t);
    ...
    fv = ['fontWeight', 'fontStyle', 'color', 'fontSize', 'fontFamily'],
    gv = (e, t) => {
      const n = e.get(t);
      return p(n)
        ? Z(
            ...
            (e) =>
              Lf(e) &&
              'span' === e.inline &&
              ((e) => f(e.styles) && H(fe(e.styles), (e) => $(fv, e)))(e)
          )
        : I.none();
    },
    pv = (e, t) => Mu(t, Ul.fromRangeStart(e)).isNone(),
    hv = (e, t) =>
      !1 ===
      Lu(t, Ul.fromRangeEnd(e)).exists(
        (e) => !ms(e.getNode()) || Lu(t, e).isSome()
      ),
    bv = (e) => (t) => ws(t) && e.isEditable(t),
    vv = (e) => Y(e.getSelectedBlocks(), bv(e.dom)),
    yv = dn.each,
    Cv = (e) => Xr(e) && !Ju(e) && !zu(e) && !ts(e),
    wv = (e, t) => {
      for (let n = e; n; n = n[t]) {
    ...
    Sv = (e, t, n) => {
      yv(e.childNodes, (e) => {
        Cv(e) && (t(e) && n(e), e.hasChildNodes() && Sv(e, t, n));
      });
    },
    _v = (e, t) => (n) => !(!n || !Rf(e, n, t)),
    kv = (e, t, n) => (o) => {
    ...
    Nv = ke([{ keep: [] }, { rename: ['name'] }, { removed: [] }]),
    Av = /^(src|href|style)$/,
    Rv = dn.each,
    Dv = Nf,
    Tv = (e, t, n) => e.isChildOf(t, n) && t !== n && !e.isBlock(n),
    Ov = (e, t, n) => {
    ...
    Mv = (e, t, n) => {
      ...
      (Bf(n) &&
        o === s.getRoot() &&
        ((n.list_block && Dv(t, n.list_block)) ||
          q(ce(t.childNodes), (t) => {
            xf(e, a, t.nodeName.toLowerCase())
              ? r
                ? r.appendChild(t)
                : ((r = Pv(s, t, a)), s.setAttribs(r, Md(e)))
              : (r = null);
          })),
    ...
    Uv = (e, t, n, o, r) => {
      ...
      (Rv(n.styles, (a, i) => {
        const { name: l, value: d } = Iv(i, a, o),
          c = Af(d, l);
        ((n.remove_similar || h(d) || !Xr(r) || Dv(Rf(e, r, l), c)) &&
          e.setStyle(t, l, ''),
          (s = !0));
      }),
        s && Fv(e, t));
        ...
        (Uv(s, l, t, n, r),
          Rv(t.attributes, (e, o) => {
            ...
            if (
              ...
              if (
                (Av.test(a) && l.removeAttribute('data-mce-' + a),
                'style' === a &&
                  Jr(['li'])(l) &&
      ...
      (o || e.selection.isEditable()) &&
        ((e, t, n, o, r) => {
          const s = e.formatter.get(t),
            ...
            c = (t) => H(s, (o) => Hv(e, o, n, t, t)),
            m = (t) => {
              const n = ce(t.childNodes),
                o = c(t) || H(s, (e) => Xb(i, t, e)),
                r = t.parentNode;
            ...
            f = (t) => {
              ...
              if (a.split) {
                if (
                  ((r = Gg(r)), (n = Ov(e, r, !0)), (o = Ov(e, r)), n !== o)
                ) {
    ...
    Vv = ['fontsize', 'subscript', 'superscript'],
    qv = ['strikethrough', ...Vv],
    Wv = (e, t) =>
      H(Vv, (n) =>
        ...
        ((e, t, n, o, r) => {
          ...
          return ((e, t) => {
            ...
            return {
              ...
              outerWrappers: [
                ...r(Ao(t)).toArray(),
                ...te(s.slice(0, e), (e) => (n(e) ? r(e).toArray() : [Ao(e)]))
              ]
            };
          });
        })(s, t, n, o, r).each(
    ...
    Gv = (e) => ['h1', 'h2', 'h3', 'h4', 'h5', 'h6'].includes(e.name),
    Xv = (e, t, n, o) => {
      const r = n.name;
    ...
    oy = (e, t, n = e.parent) => {
      if (t.getSpecialElements()[e.name]) e.empty().remove();
        ...
        const o = e.children();
        for (const e of o) n && !t.isValidChild(n.name, e.name) && oy(e, t, n);
        e.unwrap();
      }
    },
    ry = (e, t, n, o = S) => {
        ...
        if (c && f.length > 1)
          if (sy(t, i, c)) oy(i, t);
            ...
            (ty(t, s, a, m)
              ...
              (c = f[0]),
              (ty(t, s, a, c) || ey(c, 'br')) && c.empty().remove());
          }
        else if (i.parent) {
          if ('li' === i.name) {
            let e = i.prev;
  ...
  let gy = 0;
  const py = (e, t, n) =>
      my(e).bind(({ data: e, type: o, base64Encoded: r }) => {
    ...
    hy = (e, t, n) => {
      const o = e.create('blobid' + gy++, t, n);
      return (e.add(o), o);
    },
    by = (e, t, n = !1) =>
      py(t, n, (t, n) =>
        I.from(e.getByData(t, n)).orThunk(() =>
          uy(n, t).map((n) => hy(e, n, t))
        )
      ),
    vy =
    ...
    wy = (e, t) => Xe(e, `${t}/`),
    {
      ...
      isFrozen: Sy,
      getPrototypeOf: _y,
      getOwnPropertyDescriptor: ky
    } = Object;
  let { freeze: Ny, seal: Ay, create: Ry } = Object,
    { apply: Dy, construct: Ty } = 'undefined' != typeof Reflect && Reflect;
  (Ny ||
    (Ny = function (e) {
      return e;
    }),
  ...
  const Oy = Ky(Array.prototype.forEach),
    By = Ky(Array.prototype.lastIndexOf),
    Py = Ky(Array.prototype.pop),
    Ly = Ky(Array.prototype.push),
    My = Ky(Array.prototype.splice),
    Iy = Ky(String.prototype.toLowerCase),
    Fy = Ky(String.prototype.toString),
    Uy = Ky(String.prototype.match),
    zy = Ky(String.prototype.replace),
    jy = Ky(String.prototype.indexOf),
    $y = Ky(String.prototype.trim),
    Hy = Ky(Object.prototype.hasOwnProperty),
    Vy = Ky(RegExp.prototype.test),
    qy =
      ((Wy = TypeError),
      function () {
  ...
  function Yy(e, t) {
    let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : Iy;
    xy && xy(e, null);
    let o = t.length;
    for (; o--; ) {
      let r = t[o];
  ...
  function Gy(e) {
    for (let t = 0; t < e.length; t++) Hy(e, t) || (e[t] = null);
    return e;
  }
  function Xy(e) {
    const t = Ry(null);
    for (const [n, o] of Ey(e))
      Hy(e, n) &&
        (Array.isArray(o)
          ? (t[n] = Gy(o))
  ...
  function Qy(e, t) {
    for (; null !== e; ) {
      const n = ky(e, t);
      if (n) {
        if (n.get) return Ky(n.get);
        if ('function' == typeof n.value) return Ky(n.value);
      }
      e = _y(e);
    }
    return function () {
  ...
  var wC = (function e() {
    ...
    let { IS_ALLOWED_URI: I } = yC,
      F = null;
    const U = Yy({}, [...Zy, ...Jy, ...eC, ...nC, ...rC]);
    let z = null;
    const j = Yy({}, [...sC, ...aC, ...iC, ...lC]);
    let $ = Object.seal(
        Ry(null, {
          tagNameCheck: {
            writable: !0,
    ...
    let ce = null;
    const me = Yy({}, ['audio', 'video', 'img', 'source', 'image', 'track']);
    let ue = null;
    const fe = Yy({}, [
        'alt',
        'class',
    ...
    let be = he,
      ve = !1,
      ye = null;
    const Ce = Yy({}, [ge, pe, he], Fy);
    let we = Yy({}, ['mi', 'mo', 'mn', 'ms', 'mtext']),
      Ee = Yy({}, ['annotation-xml']);
    const xe = Yy({}, ['title', 'style', 'font', 'a', 'script']);
    let Se = null;
          ...
          if (
            ...
            (Se =
              -1 === _e.indexOf(e.PARSER_MEDIA_TYPE)
                ? 'text/html'
                : e.PARSER_MEDIA_TYPE),
            (ke = 'application/xhtml+xml' === Se ? Fy : Iy),
            (F = Hy(e, 'ALLOWED_TAGS') ? Yy({}, e.ALLOWED_TAGS, ke) : U),
            (z = Hy(e, 'ALLOWED_ATTR') ? Yy({}, e.ALLOWED_ATTR, ke) : j),
            (ye = Hy(e, 'ALLOWED_NAMESPACES')
              ? Yy({}, e.ALLOWED_NAMESPACES, Fy)
              : Ce),
            (ue = Hy(e, 'ADD_URI_SAFE_ATTR')
              ? Yy(Xy(fe), e.ADD_URI_SAFE_ATTR, ke)
              : fe),
            (ce = Hy(e, 'ADD_DATA_URI_TAGS')
              ? Yy(Xy(me), e.ADD_DATA_URI_TAGS, ke)
              : me),
            (le = Hy(e, 'FORBID_CONTENTS')
              ? Yy({}, e.FORBID_CONTENTS, ke)
              : de),
            (H = Hy(e, 'FORBID_TAGS') ? Yy({}, e.FORBID_TAGS, ke) : Xy({})),
            (V = Hy(e, 'FORBID_ATTR') ? Yy({}, e.FORBID_ATTR, ke) : Xy({})),
            (ie = !!Hy(e, 'USE_PROFILES') && e.USE_PROFILES),
            ...
            ie &&
              ((F = Yy({}, rC)),
              (z = []),
              !0 === ie.html && (Yy(F, Zy), Yy(z, sC)),
              !0 === ie.svg && (Yy(F, Jy), Yy(z, aC), Yy(z, lC)),
              !0 === ie.svgFilters && (Yy(F, eC), Yy(z, aC), Yy(z, lC)),
              !0 === ie.mathMl && (Yy(F, nC), Yy(z, iC), Yy(z, lC))),
            e.ADD_TAGS && (F === U && (F = Xy(F)), Yy(F, e.ADD_TAGS, ke)),
            e.ADD_ATTR && (z === j && (z = Xy(z)), Yy(z, e.ADD_ATTR, ke)),
            e.ADD_URI_SAFE_ATTR && Yy(ue, e.ADD_URI_SAFE_ATTR, ke),
            e.FORBID_CONTENTS &&
              (le === de && (le = Xy(le)), Yy(le, e.FORBID_CONTENTS, ke)),
            se && (F['#text'] = !0),
            Q && Yy(F, ['html', 'head', 'body']),
            F.table && (Yy(F, ['tbody']), delete H.tbody),
    ...
    const ze = function (e) {
        let t = null;
        if ((Ue(A.beforeSanitizeElements, e, null), Ie(e))) return (Be(e), !0);
        const o = ke(e.nodeName);
        if (
          (Ue(A.uponSanitizeElement, e, { tagName: o, allowedTags: F }),
          X &&
            e.hasChildNodes() &&
        ...
        if (X && 8 === e.nodeType && Vy(/<[/\w]/g, e.data)) return (Be(e), !0);
        if (!F[o] || H[o]) {
          if (!H[o] && $e(o)) {
        ...
        return e instanceof d &&
          ...
          : ('noscript' !== o && 'noembed' !== o && 'noframes' !== o) ||
              !Vy(/<\/no(script|embed|frames)/i, e.innerHTML)
            ? (G &&
                3 === e.nodeType &&
                ((t = e.textContent),
                Oy([R, D, T], (e) => {
                ...
                e.textContent !== t &&
                  (Ly(n.removed, { element: e.cloneNode() }),
                  (e.textContent = t))),
              Ue(A.afterSanitizeElements, e, null),
              !1)
            : (Be(e), !0);
      },
      je = function (e, t, n) {
        if (oe && ('id' === t || 'name' === t) && (n in o || n in Ae))
          return !1;
        if (W && !V[t] && Vy(O, t));
        else if (q && Vy(B, t));
        else if (!z[t] || V[t]) {
      ...
      $e = function (e) {
        return 'annotation-xml' !== e && Uy(e, M);
      },
      He = function (e) {
        Ue(A.beforeSanitizeAttributes, e, null);
        ...
        for (; r--; ) {
          ...
          if (
            ...
            Ue(A.uponSanitizeAttribute, e, o),
            (m = o.attrValue),
            !re ||
              ('id' !== d && 'name' !== d) ||
              (Pe(a, e), (m = 'user-content-' + m)),
            X && Vy(/((--!?|])>)|<\/(style|title)/i, m))
          ) {
            Pe(a, e);
            continue;
          }
            ...
            if (m !== c)
              try {
                (i ? e.setAttributeNS(i, a, m) : e.setAttribute(a, m),
                  Ie(e) ? Be(e) : Py(n.removed));
              } catch (t) {
                Pe(a, e);
              }
          } else Pe(a, e);
        }
        Ue(A.afterSanitizeAttributes, e, null);
      },
      Ve = function e(t) {
        let n = null;
        const o = Me(t);
        for (Ue(A.beforeSanitizeShadowDOM, t, null); (n = o.nextNode()); )
          (Ue(A.uponSanitizeShadowNode, n, null),
            ze(n),
            He(n),
            n.content instanceof a && e(n.content));
        Ue(A.afterSanitizeShadowDOM, t, null);
      };
    return (
      (n.sanitize = function (e) {
        ...
        return (
          Q &&
            ...
            Vy(bC, o.ownerDocument.doctype.name) &&
  ...
  const EC = dn.each,
    ...
    _C = { ftp: 21, http: 80, https: 443, mailto: 25 },
    kC = ['img', 'video'],
    NC = (e, t, n) => {
      const o = ((e) => {
        try {
  ...
  class AC {
    ...
    toRelative(e) {
      if ('./' === e) return e;
      const t = new AC(e, { base_uri: this });
      if (
    ...
    toAbsolute(e, t) {
      const n = new AC(e, { base_uri: this });
  ...
  const OC = (e, t, n, o, r) => {
        ...
        if ((C(r) && (r.allowedTags[m] = !0), d && h && !g)) {
          if (
            (q(
              ...
              (e) => {
                ho(f, e.name, '{$uid}' === e.value ? 'mce_' + TC++ : e.value);
              }
            ),
            q(
    ...
    PC = (e, t) =>
      e.hasAttribute(DC) && ('id' === t || 'class' === t || 'style' === t),
    LC = (e, t) => e in t.getBoolAttrs(),
    MC = (e, t, n, o) => {
      ...
      for (let s = r.length - 1; s >= 0; s--) {
        const a = r[s],
          i = a.name,
          l = a.value;
        BC(t, n, o, e.tagName.toLowerCase(), i, l) || PC(e, i)
          ? LC(i, n) && e.setAttribute(i, i)
          : e.removeAttribute(i);
      }
    },
    IC = (e, t, n) => {
    ...
    zC = ['script', 'style', 'template', 'param'],
    jC = dn.makeMap,
    $C = dn.extend,
    HC = (e, t, n, o, r) => {
      const s = e.name,
    ...
    VC = (e = {}, t = Pa()) => {
        ...
        p = {
          ...
          parse: (e, n = {}) => {
                    ...
                    if (1 === e.type) {
                      ...
                      if (r && i) {
                        ...
                        ((e) => {
                          let n = e;
                          for (; C(n); ) {
                            if (n.name in l) return ty(t, s, a, n);
                            n = n.parent;
                          }
                          return !1;
                        })(e)
            ...
            (((e, t, n) => {
              ...
              i &&
                h.length > 0 &&
                (n.context ? (n.invalid = !0) : ry(h, t, u, w)));
            const E = ((e, t) => {
              var n;
              const o =
            ...
            return (
              E &&
                ...
                ((e, n) => {
                  const o = $C(jC(zC), t.getBlockElements()),
                    s = /^[ \t\r\n]+/,
                    a = /[ \t\r\n]+$/;
                  let i = e.firstChild,
                    l = null;
      ...
      return (
        ...
        ((e, t, n) => {
          t.inline_styles && cy(e, t, n);
        })(p, r, t),
        p
      );
    },
    qC = (e) => e instanceof xp,
    WC = (e, t, n) => {
      const o = ((e) => (qC(e) ? $p({ validate: !1 }).serialize(e) : e))(e),
        r = t(o);
      if (r.isDefaultPrevented()) return r;
      if (qC(e)) {
        if (r.content !== o) {
          const t = VC({ validate: !1, forced_root_block: !1, ...n }).parse(
            r.content,
            { context: e.name }
          );
          return { ...r, content: t };
    ...
    KC = (e) => ({
      sanitize: um(e),
      sandbox_iframes: vm(e),
      sandbox_iframes_exclusions: ym(e)
    }),
    YC = (e, t) => {
      if (t.no_events) return De.value(t);
      {
        ...
        return n.isDefaultPrevented()
          ? De.error(vd(e, { content: '', ...n }).content)
          : De.value(n);
      }
    },
    GC = (e, t, n) => {
    ...
    XC = (e, t) => {
      if (t.no_events) return De.value(t);
      {
        ...
        return n.isDefaultPrevented()
          ? (bd(e, n), De.error(void 0))
          : De.value(n);
      }
    },
    QC = (e, t, n) => {
      n.no_events || bd(e, { ...n, content: t });
    },
    ZC =
    ...
    tw = [{ name: 'export', replacedWith: 'Export to PDF' }],
    nw = (e, t) => {
    ...
    cw = (e) => {
      console.warn(dw[e], new Error().stack);
    },
    mw = (e) => (0 === e.dom.length ? (_o(e), I.none()) : I.some(e)),
    uw = (e, t, n, o, r) => {
      e.bind(
        (e) => (
    ...
    fw = (e, t, n = {}) => {
      ...
      XC(e, o).each((t) => {
        ...
        (((e, t, n) => {
          ...
          const s = o.bind(Un).filter(An).bind(mw),
            a = r.bind(zn).filter(An).bind(mw);
          (uw(s, o, e, !0, n), uw(a, r, e, !1, n), e.collapse(!1));
    ...
    vw = (e, t, n, o) => {
      ...
      return s
        ? c(1)
          ...
          : c(2)
            ? ((e, t, n, o) => (o.insertAfter(t.reverse(), e), bw(t[0], n)))(
                s,
                a,
                d,
                t
    ...
    ww = (e, t) => {
      ...
      if (t) {
        ...
        (dn.each(a, (e) => {
          ...
          ((e, t) => {
            const n = Y(t, (t) => Wv(e.formatter, t));
            Yv(e, 'strikethrough', n);
          })(e, To(a)));
      }
    },
    Ew = (e, t, n) => {
      ...
      (m === u &&
        ...
        r.isCollapsed() ||
          ((e) => {
            const t = e.dom,
              n = ay(e.selection.getRng());
            e.selection.setRng(n);
            const o = t.getParent(n.startContainer, Cw);
            ((e, t, n) =>
              !!C(n) &&
              n === e.getParent(t.endContainer, Cw) &&
      ...
      const f = r.getNode(),
        ...
        p = a.parse(t, g);
      if (!0 === n.paste && gw(e.schema, p) && ((e, t) => !!hw(e, t))(s, f))
        return ((c = vw(l, s, r.getRng(), p)), c && r.setRng(c), t);
      (!0 === n.paste &&
        ((e, t, n, o) => {
          var r;
      ...
      if (
        ...
        (ry(g, e.schema, u),
          Zv(a.getNodeFilters(), a.getAttributeFilters(), c),
          (t = l.serialize(c)),
  ...
  const kw = dn.each,
    ...
    Aw = (e, t, n, o) => {
          ...
          (eg(a, i, (o) => {
            ...
            const c = (o) => {
              ...
              if (
                ms(o) &&
                !((e, t, n, o) => {
                  if (wc(e) && Lf(t) && n.parentNode) {
                    const t = Oa(e.schema),
                      r = _r(mn.fromDom(n), (e) => zu(e.dom));
                    return (
                      _e(t, o) &&
                      As(e.schema, n.parentNode, {
                        skipBogus: !1,
                        includeZwsp: !0
                      }) &&
                      !r
              ...
              if (
                ((o) =>
                  ((e) => Bf(e) && !0 === e.wrapper)(s) && Zb(e, o, t, n))(o)
              )
                i = null;
              else {
                if (
              ...
              (!(m.length > 1) && a.isBlock(o)) || 0 !== i
                ? (Lf(s) || (Bf(s) && s.wrapper)) &&
                  (s.exact ||
                    ...
                    (o = ((t) => {
                      const o = Z(t.childNodes, vf).filter(
                        (e) =>
                          'false' !== a.getContentEditable(e) && Xb(a, e, s)
                      );
                      return o
                        .map((o) => {
                          const r = a.clone(o, !1);
                  ...
                  ((e, t, n, o) => {
                    kw(t, (t) => {
                      (Lf(t) &&
                        kw(e.dom.select(t.inline, o), (o) => {
                          Cv(o) && Hv(e, t, n, o, t.exact ? o : null);
                        }),
                        ((e, t, n) => {
                  ...
                  ((e, t, n, o, r) => {
                    ...
                    (Zb(e, s, n, o) && Hv(e, t, o, r)) ||
                      (t.merge_with_parents &&
                        s &&
                        e.dom.getParent(
                          s,
                          (s) => !!Zb(e, s, n, o) && (Hv(e, t, o, r), !0)
                        ));
                  })(e, s, t, n, o),
                  ((e, t, n, o) => {
      ...
      if ('false' === i.getContentEditable(f) && !_f(e, f))
        return (d(r, (o = f)), void pd(e, t, o, n));
      if (s) {
        if (o)
          if (bf(o)) {
            if (!d(r, o)) {
    ...
    Rw = (e, t, n, o) => {
      (o || e.selection.isEditable()) && Aw(e, t, n, o);
    },
    Dw = (e) => Se(e, 'vars'),
    Tw = (e) => e.selection.getStart(),
    Ow = (e, t, n, o, r) =>
      Q(
        t,
        (t) => {
    ...
    Pw = (e, t, n) => {
      ...
      pe(n, (n, r) => {
        const s = (n) => {
          const s = Ow(e, o, r, n.similar, Dw(n) ? n.vars : void 0),
            a = s.isSome();
          if (n.state.get() !== a) {
            n.state.set(a);
            const e = s.getOr(t);
    ...
    Lw = (e, t, n) => ({ element: e, width: t, rows: n }),
    Mw = (e, t) => ({ element: e, cells: t }),
    Iw = (e, t) => ({ x: e, y: t }),
    Fw = (e, t) => yo(e, t).bind(rt).getOr(1),
    Uw = (e, t, n) => {
      const o = e.rows;
      return !!(o[n] ? o[n].cells : [])[t];
    },
    zw = (e) => X(e, (e, t) => (t.cells.length > e ? t.cells.length : e), 0),
    jw = (e, t) => {
      const n = e.rows;
      for (let e = 0; e < n.length; e++) {
        const o = n[e].cells;
        for (let n = 0; n < o.length; n++)
          if (vn(o[n], t)) return I.some(Iw(n, e));
      }
      return I.none();
    },
    $w = (e, t, n, o, r) => {
              ...
              jw(e, n).map((n) =>
                ((e, t, n) => {
                  const o = t.x,
                    ...
                    s = n.x,
                    a = n.y,
                    i = r < a ? $w(e, o, r, s, a) : $w(e, o, a, s, r);
                  return Lw(e.element, zw(i), i);
                })(e, t, n)
              )
            ))(r, n, o).map((e) => Zo([Hw(e)]));
        })
        ...
        : ((e, t, n) =>
            t.length > 0 && t[0].collapsed
              ...
              : ((e, t, n) =>
                  ...
                  })(mn.fromDom(t.cloneContents()), Vw(e, t, n)))(e, t[0], n))(
            e,
            t,
            n
          );
    },
    Yw = (e, t) => t >= 0 && t < e.length && nf(e.charAt(t)),
    Gw = (e) => ji(e.innerText),
    Xw = (e) =>
      Xr(e)
        ? e.outerHTML
    ...
    Qw = (e, t) => (
      ((e, t) => {
        ...
        })(V(ce(t.childNodes), Xw), e),
        t
      ),
      t
    ),
    Zw = it(() => document.implementation.createHTMLDocument('undo')),
    Jw = (e) => {
      ...
      return ((e) => null !== e.querySelector('iframe'))(n)
        ? {
            type: 'fragmented',
            fragments: Y(V(ce(n.childNodes), _(ji, Xw)), (e) => e.length > 0),
            content: '',
            bookmark: null,
            beforeBookmark: null
          }
    ...
    tE = (e) => ('fragmented' === e.type ? e.fragments.join('') : e.content),
    nE = (e) => {
      const t = mn.fromTag('body', Zw());
      return (Bo(t, tE(e)), q(xr(t, '*[data-mce-bogus]'), ko), Oo(t));
    },
    oE = (e, t) =>
      !(!e || !t) &&
      (!!((e, t) => tE(e) === tE(t))(e, t) ||
    ...
    iE = (e) => ({
      ...
      undoManager: {
        beforeChange: (t, n) =>
          ((e, t, n) => {
            rE(t) && n.set(ad(e.selection));
          })(e, t, n),
        add: (t, n, o, r, s, a) =>
          ((e, t, n, o, r, s, a) => {
            const i = Jw(e),
              l = dn.extend(s || {}, i);
            if (!rE(o) || e.removed) return null;
        ...
        undo: (t, n, o) =>
          ((e, t, n, o) => {
            let r;
            return (
              t.typing && (t.add(), (t.typing = !1), sE(t, !1, n)),
              o.get() > 0 &&
                (o.set(o.get() - 1),
                (r = t.data[o.get()]),
                eE(e, r, !0),
        ...
        hasUndo: (t, n) =>
          ((e, t, n) =>
            n.get() > 0 || (t.typing && t.data[0] && !oE(Jw(e), t.data[0])))(
            e,
            t,
            n
          ),
        ...
        transact: (e, t, n) =>
          ((e, t, n) => (aE(e, t), e.beforeChange(), e.ignore(n), e.add()))(
            e,
            t,
            n
          ),
      ...
      formatter: {
        ...
        matchNode: (t, n, o, r) => Zb(e, t, n, o, r),
        canApply: (t) =>
          ((e, t) => {
            ...
            return I.from(e.selection.getStart(!0))
              .bind((o) =>
                Ar(
                  ...
                  (n) =>
                    me(t, (t) =>
                      ((t, n) => (Zb(e, t.dom, n) ? I.some(n) : I.none()))(n, t)
                    ),
                  n
                )
              )
        ...
        apply: (t, n, o) => Rw(e, t, n, o),
        remove: (t, n, o, r) => $v(e, t, n, o, r),
        toggle: (t, n, o) =>
          ((e, t, n, o) => {
            const r = e.formatter.get(t);
            r &&
              (!Jb(e, t, n, o) || ('toggle' in r[0] && !r[0].toggle)
                ? Rw(e, t, n, o)
                : $v(e, t, n, o));
          })(e, t, n, o),
                      ...
                      if (0 === (n = ji(n)).length || /^\s+$/.test(n)) {
                        ...
                        return (
                          e.schema.isValidChild(
                            ...
                            ? ((n = r), (n = e.dom.createHTML(s, Md(e), n)))
                            : n || (n = r),
                          xw(e, n, o.no_selection),
                          { content: n, html: n }
                        );
                      }
                      {
                        ...
                        return (
                          xw(e, r, o.no_selection),
                          { content: r, html: r }
                        );
                      }
                    })(e, o, t, n)
              )
              .getOr({ content: t, html: qC(n.content) ? '' : n.content }))(
            e,
            t,
            n
          ),
        insertContent: (t, n) => Ew(e, t, n),
        addVisual: (t) =>
          ((e, t) => {
            const n = e.dom,
              o = C(t) ? t : e.getBody();
                  ...
                  return ((e) =>
                    I.from(e.selection.getRng())
                      .map((t) => {
                        ...
                        if (
                          (e.dom.remove(i), Yw(d, 0) || Yw(d, d.length - 1))
                        ) {
                          const e = o.getOr(r),
                            t = Gw(e),
                            n = t.indexOf(l);
                      ...
                      .getOr(''))(e);
                {
                  const n = ((e, t) => {
                    const n = e.selection.getRng(),
                      ...
                      s = vp(e, rf(r)),
                      a = t.contextual
                        ? Kw(mn.fromDom(e.getBody()), s, e.schema).dom
                        : n.cloneContents();
                    return (
                      a && o.appendChild(a),
    ...
    lE = (e) => Se(e.plugins, 'rtc'),
    dE = (e) => (e.rtcInstance ? e.rtcInstance : iE(e)),
    cE = (e) => {
      const t = e.rtcInstance;
      if (t) return t;
      throw new Error('Failed to get RTC instance not yet initialized.');
    },
    mE = (e) => cE(e).init.bindEvents(),
    uE = (e, t, n) => {
      if (Se(e, t)) {
        const o = Y(e[t], (e) => e !== n);
  ...
  const fE = (e) =>
    ...
    gE = (e, t, n, o) => {
      ...
      const { selectorChangedWithUnbind: a } = ((e, t) => {
        ...
        c = (e, t) => {
          if (!((e) => !!e && fE(e.startContainer) && fE(e.endContainer))(e))
            return;
          const n = l();
          if (
        ...
        u = {
          ...
          getContent: (e) =>
            ((e, t = {}) =>
              ((e, t, n) => cE(e).selection.getContent(t, n))(
                e,
          ...
          setContent: (e, t) =>
            ((e, t, n = {}) => {
              (cw('selectionSetContent'), fw(e, t, n));
            })(o, e, t),
          ...
          isForward: m,
          setNode: (t) => (fw(o, e.getOuterHTML(t)), t),
          getNode: () =>
            ((e, t) => {
              if (!t) return e;
    ...
    vE = (e, t, n = {}) => {
      ...
      XC(e, o).each((t) => {
        const n = ((e, t, n) => dE(e).editor.setContent(t, n))(e, t.content, t);
        QC(e, n.html, t);
      });
    },
    yE = li.DOM,
    CE = (e) => I.from(e).each((e) => e.destroy()),
    wE = (() => {
      const e = {};
      return {
        add: (t, n) => {
    ...
    EE = pi.ModelManager,
    xE = (e, t) => t.dom[e],
    SE = (e, t) => parseInt(Uo(t, e), 10),
    _E = D(xE, 'clientWidth'),
    kE = D(xE, 'clientHeight'),
    NE = D(SE, 'margin-top'),
    AE = D(SE, 'margin-left'),
    RE = (e) => {
      const t = [],
    ...
    LE = (e, t, n) => {
      (gd(e, t, { message: n }), console.error(n));
    },
    ME = (e, t, n) =>
      n
    ...
    $E = 'Read more: https://www.tiny.cloud/docs/tinymce/latest/license-key/',
    HE =
    ...
    qE = 'licensekeymanager',
    WE = (e) => {
      const t = ((e) => (u(Em(e)) ? 'online' : 'offline'))(e),
        n = ((e) => {
          var t;
          const n =
            null === (t = wm(e)) || void 0 === t ? void 0 : t.toLowerCase();
          return 'gpl' === n ? 'gpl' : y(n) ? 'no_key' : 'non_gpl';
        })(e),
        o = new Set(Pc(e)).has(qE);
                ...
                n(
                  ((e) => ({
                    validate: (t) => {
                      const { plugin: n } = t,
                        o = u(n);
                      return (o && VE(e, n), Promise.resolve(!o));
                    }
                  }))(t)
                );
                break;
                ...
                (((e) => {
                  ...
                  n(
                    ((e) => ({
                      validate: (t) => {
                        const { plugin: n } = t;
                        return (u(n) && VE(e, n), Promise.resolve(!1));
                      }
                    }))(t)
                  ),
    ...
    JE = (e) => {
      const t = mn.fromDom(e.getBody());
      (QE(t, 'mce-content-readonly', !1),
        e.hasEditableRoot() && Cr(t, !0),
        ((e, t) => {
          (XE(e, 'StyleWithCSS', t),
            XE(e, 'enableInlineTableEditing', t),
            XE(e, 'enableObjectResizing', t));
        })(e, !1),
        Tg(e) && e.focus(),
        ((e) => {
    ...
    ox = (e) => {
      (e.parser.addAttributeFilter('contenteditable', (t) => {
        ex(e) &&
          q(t, (e) => {
            (e.attr(tx, e.attr('contenteditable')),
              e.attr('contenteditable', 'false'));
          });
      }),
        e.serializer.addAttributeFilter(tx, (t) => {
          ex(e) &&
            q(t, (e) => {
              e.attr('contenteditable', e.attr(tx));
            });
        }),
        e.serializer.addTempAttr(tx));
    },
    rx = ['copy'],
    sx = (e) => 'content/' + e + '/content.css',
    ax = (e, t) => {
      const n = e.editorManager.baseURL + '/skins/content',
        o = `content${e.editorManager.suffix}.css`;
      return V(t, (t) =>
        ((e) => tinymce.Resource.has(sx(e)))(t)
          ? t
                    ...
                    return C(s)
                      ...
                      : ((o = t),
                        Xe(o, 'blob:')
                          ...
                          fy(t).then((o) =>
                            py(o, !1, (n) => I.some(hy(e, t, n))).getOrThunk(n)
                          )
                        );
                  }
                  var o, r;
                  return Xe(t, 'data:')
                    ? by(e, t).fold(n, (e) => Promise.resolve(e))
  ...
  const cx = (e, t) => {
    ...
    gx = { remove_similar: !0, inherit: !1 },
    px = { selector: 'td,th', ...gx },
    hx = {
      tablecellbackgroundcolor: {
        styles: { backgroundColor: '%value' },
        ...px
      },
      tablecellverticalalign: { styles: { 'vertical-align': '%value' }, ...px },
      tablecellbordercolor: { styles: { borderColor: '%value' }, ...px },
      tablecellclass: { classes: ['%value'], ...px },
      tableclass: { selector: 'table', classes: ['%value'], ...gx },
      tablecellborderstyle: { styles: { borderStyle: '%value' }, ...px },
      tablecellborderwidth: { styles: { borderWidth: '%value' }, ...px }
    },
    bx = N(hx),
    vx = dn.each,
    yx = li.DOM,
    ...
    wx = (e, t) => {
      const n = (t && t.schema) || Pa({}),
        o = (e) => {
          ...
          return (
            ((e, t) => {
              (t.classes.length > 0 && yx.addClass(e, t.classes.join(' ')),
                yx.setAttribs(e, t.attrs));
            })(n, t),
            n
          );
        },
        r = (e, t, s) => {
          ...
          const m = Cx(a) ? a.siblings : void 0;
          return r(c, t, m);
        },
        s = yx.create('div');
      if (e.length > 0) {
    ...
    xx = (e, t) => {
      ...
      const r = (e) => (u(e) ? e.replace(/%(\w+)/g, '') : ''),
        s = (t, n) => yx.getStyle(null != n ? n : e.getBody(), t, !0);
      if (u(t)) {
        const n = e.formatter.get(t);
        if (!n) return '';
        t = n[0];
      ...
      var d;
      l.length > 0
        ? (l[0].name || (l[0].name = i), (i = t.selector), (a = wx(l, e)))
        : (a = wx([i], e));
      const c = yx.select(i, a)[0] || a.firstChild;
      (vx(t.styles, (e, t) => {
        const n = r(e);
        n && yx.setStyle(c, t, n);
      }),
        vx(t.attributes, (e, t) => {
          const n = r(e);
          n && yx.setAttrib(c, t, n);
        }),
        vx(t.classes, (e) => {
          const t = r(e);
          yx.hasClass(c, t) || yx.addClass(c, t);
        }),
        e.dispatch('PreviewFormats'),
        yx.setStyles(a, { position: 'absolute', left: -65535 }),
    ...
    Sx = (e) => {
      ...
      return (
          ...
          e.on('mouseup keydown', (t) => {
            ...
            ((e, t, n) => {
              ...
              (rv(e, null, n),
                (8 !== t && 46 !== t) ||
                  !o.isCollapsed() ||
                  o.getStart().innerHTML !== ev ||
                  rv(e, ju(r, o.getStart()), !0),
                (37 !== t && 39 !== t) || rv(e, ju(r, o.getStart()), !0));
            })(
              e,
              t.keyCode,
              ((n = e.selection.getRng().endContainer), ss(n) && Qe(n.data, dt))
            );
          });
        })(e),
        lE(e) ||
          ...
          })(n, e),
        {
          ...
          apply: (t, n, o) => {
            ((e, t, n, o) => {
              cE(e).formatter.apply(t, n, o);
            })(e, t, n, o);
          },
          remove: (t, n, o, r) => {
            ((e, t, n, o, r) => {
              cE(e).formatter.remove(t, n, o, r);
            })(e, t, n, o, r);
          },
          toggle: (t, n, o) => {
            ((e, t, n, o) => {
              cE(e).formatter.toggle(t, n, o);
            })(e, t, n, o);
          },
          match: (t, n, o, r) =>
            ((e, t, n, o, r) => cE(e).formatter.match(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          closest: (t) => ((e, t) => cE(e).formatter.closest(t))(e, t),
          matchAll: (t, n) =>
            ((e, t, n) => cE(e).formatter.matchAll(t, n))(e, t, n),
          matchNode: (t, n, o, r) =>
            ((e, t, n, o, r) => cE(e).formatter.matchNode(t, n, o, r))(
              e,
              t,
              n,
              o,
          ...
          canApply: (t) => ((e, t) => cE(e).formatter.canApply(t))(e, t),
          formatChanged: (t, o, r, s) =>
            ((e, t, n, o, r, s) =>
              cE(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: D(xx, e)
        }
      );
    },
    ...
    kx = (e) => {
      const t = We(),
        ...
        r = {
          ...
          beforeChange: () => {
            ((e, t, n) => {
              cE(e).undoManager.beforeChange(t, n);
            })(e, n, t);
          },
          add: (s, a) =>
            ((e, t, n, o, r, s, a) => cE(e).undoManager.add(t, n, o, r, s, a))(
              e,
              r,
              o,
              n,
          ...
          undo: () =>
            ((e, t, n, o) => cE(e).undoManager.undo(t, n, o))(e, r, n, o),
          redo: () => ((e, t, n) => cE(e).undoManager.redo(t, n))(e, o, r.data),
          clear: () => {
            ((e, t, n) => {
              cE(e).undoManager.clear(t, n);
            })(e, r, o);
          },
          reset: () => {
            ((e, t) => {
              cE(e).undoManager.reset(t);
            })(e, r);
          },
          hasUndo: () =>
            ((e, t, n) => cE(e).undoManager.hasUndo(t, n))(e, r, o),
          hasRedo: () =>
            ((e, t, n) => cE(e).undoManager.hasRedo(t, n))(e, r, o),
          transact: (t) =>
            ((e, t, n, o) => cE(e).undoManager.transact(t, n, o))(e, r, n, t),
          ignore: (t) => {
            ((e, t, n) => {
              cE(e).undoManager.ignore(t, n);
            })(e, n, t);
          },
          extra: (t, n) => {
            ((e, t, n, o, r) => {
              cE(e).undoManager.extra(t, n, o, r);
            })(e, r, o, t, n);
          }
        };
      return (
    ...
    Ax = 'data-mce-placeholder',
    Rx = (e) => 'keydown' === e.type || 'keyup' === e.type,
    Dx = (e) => {
      const t = e.keyCode;
      return t === Bg.BACKSPACE || t === Bg.DELETE;
    },
    Tx = (e) => (t) => C(t) && e.test(t.nodeName),
    Ox = (e) => C(e) && 3 === e.nodeType,
    Bx = (e) => C(e) && 1 === e.nodeType,
    Px = Tx(/^(OL|UL|DL)$/),
    Lx = Tx(/^(OL|UL)$/),
    Mx = Tx(/^(LI|DT|DD)$/),
    Ix = Tx(/^(DT|DD)$/),
    Fx = (e) => C(e) && 'br' === e.nodeName.toLowerCase(),
    Ux = (e, t) => C(t) && t.nodeName in e.schema.getTextBlockElements(),
    zx = (e, t) => C(e) && e.nodeName in t,
    jx = (e, t) => C(t) && t.nodeName in e.schema.getVoidElements(),
    $x = (e, t, n) => {
      const o = e.isEmpty(t);
      return (
    ...
    Hx = (e, t) => e.isChildOf(t, e.getRoot()),
    Vx = (e, t) => {
      if (Ox(e)) return { container: e, offset: t };
      const n = Xg.getNode(e, t);
      return Ox(n)
        ? { container: n, offset: t >= e.childNodes.length ? n.data.length : 0 }
        : n.previousSibling && Ox(n.previousSibling)
          ? {
              container: n.previousSibling,
              offset: n.previousSibling.data.length
            }
          : n.nextSibling && Ox(n.nextSibling)
            ? { container: n.nextSibling, offset: 0 }
            : { container: e, offset: t };
    },
    qx = (e) => {
      const t = e.cloneRange(),
        n = Vx(e.startContainer, e.startOffset);
      t.setStart(n.container, n.offset);
      const o = Vx(e.endContainer, e.endOffset);
      return (t.setEnd(o.container, o.offset), t);
    },
    Wx = li.DOM,
    Kx = (e) => {
          ...
          if (Bx(o)) {
            ...
            (o.hasChildNodes()
              ? ((r = Math.min(r, o.childNodes.length - 1)),
                n
                  ? o.insertBefore(e, o.childNodes[r])
                  : Wx.insertAfter(e, o.childNodes[r]))
              : o.appendChild(e),
              (o = e),
              (r = 0));
          }
        ...
        if (n) {
          if (Bx(n) && n.parentNode) {
            ...
            ((o = ((e) => {
              ...
              for (; n; ) {
                if (n === e) return o;
                ((Bx(n) && 'bookmark' === n.getAttribute('data-mce-type')) ||
                  o++,
                  (n = n.nextSibling));
              }
              return -1;
      ...
      dn.each(n, (t) => {
        ((e, t) => {
          ...
          if (n && 'LI' === n.nodeName && n.firstChild === t) {
            ...
            o && 'LI' === o.nodeName
              ? (o.appendChild(t), $x(e, n) && Gx.remove(n))
              : Gx.setStyle(n, 'listStyleType', 'none');
          }
          if (Px(n)) {
    ...
    Jx = (e, t) => {
      ...
      return e.dom.getParent(n, Zx, nS(e, n));
    },
    eS = (e) => {
      const t = e.selection.getSelectedBlocks();
      return Y(
        ((e, t) => {
          const n = dn.map(
            t,
            (t) => e.dom.getParent(t, 'li,dd,dt', nS(e, t)) || t
          );
          return ue(n);
        })(e, t),
        Mx
    ...
    nS = (e, t) => {
      const n = e.dom.getParents(t, e.dom.isBlock),
        o = Z(n, (t) => {
          return (
            ((t) => t.nodeName.toLowerCase() !== Ld(e))(t) &&
            ((n = e.schema),
            !Px((o = t)) &&
              !Mx(o) &&
              H(Qx, (e) => n.isValidChild(o.nodeName, e)))
          );
          var n, o;
        });
    ...
    oS = (e, t) => {
      const n = e.dom.getParents(t, 'ol,ul', nS(e, t));
      return de(n);
    },
    rS = (e, t) => {
      const n = V(t, (t) => oS(e, t).getOr(t));
      return ue(n);
    },
    sS = (e) => /\btox\-/.test(e.className),
    aS = (e, t) => null !== t && !e.dom.isEditable(t),
    iS = (e, t) => {
      const n = e.dom.getParent(t, 'ol,ul,dl');
      return aS(e, n) || !e.selection.isEditable();
    },
    lS = (e, t, n) => e.dispatch('ListMutation', { action: t, element: n }),
    dS = (e, t, n = {}) => {
      const o = e.dom,
      ...
      for (
        d = o.create(a, { ...i, ...(n.style ? { style: n.style } : {}) }),
          zx(t.firstChild, r) || s.appendChild(d);
        (l = t.firstChild);
    ...
    cS = (e) => Cn(e, 'OL,UL'),
    mS = (e) => qn(e).exists(cS),
    uS = (e) => 'listAttributes' in e,
    fS = (e) => 'isComment' in e,
    gS = (e) => e.depth > 0,
    pS = (e) => e.isSelected,
    hS = (e) => {
      const t = Hn(e),
        n = Wn(e).exists(cS) ? t.slice(0, -1) : t;
      return V(n, Ro);
    },
    bS = (e, t) => {
      mo(e.item, t.list);
        ...
        .fold(
          ...
          (r) => {
            const s = X(
              ...
              (o, s, a) => {
                if (0 === a) return o;
                if (Cn(s, 'LI')) return o.concat(wS(e, t, n, s));
                {
                  const t = {
                    isFragment: !0,
                    depth: e,
            ...
            return xS(e, t, n, r).concat(s);
          }
        ),
    xS = (e, t, n, o) => te(Hn(o), (o) => (cS(o) ? xS : ES)(e + 1, t, n, o)),
    SS = (e, t) => {
      const n = CS(t);
      return ((e, t) => {
        let n = I.none();
              ...
              : o.depth > t.length
                ? ((e, t, n) => {
                    const o = ((e, t, n) => {
                      const o = [];
                      for (let r = 0; r < n; r++)
                        o.push(vS(e, uS(t) ? t.listType : t.parentListType));
                      return o;
                    })(e, n, n.depth - t.length);
                    var r;
                    return (
                      ((e) => {
                        for (let t = 1; t < e.length; t++) bS(e[t - 1], e[t]);
                      })(o),
                      ((e, t) => {
    ...
    _S = (e, t, n) => {
      const o = ((e, t) => {
        const n = Ne(!1);
        return V(e, (e) => ({ sourceList: e, entries: xS(0, t, n, e) }));
      })(
        t,
        ((e) => {
          const t = V(eS(e), mn.fromDom);
          return je(Z(t, T(mS)), Z(oe(t), T(mS)), (e, t) => ({
            start: e,
            end: t
          }));
        })(e)
                ...
                : ((e, t) => {
                    ...
                    return V(n, (t) => {
                      const n = fS(t)
                          ...
                          : Zo(t.content),
                        o = uS(t) ? t.itemAttributes : {};
                      return mn.fromDom(dS(e, n.dom, o));
                    });
                  })(e, t)
          ))(e, t.entries);
        var r;
        (q(o, (t) => {
          lS(e, 'Indent' === n ? 'IndentList' : 'OutdentList', t.dom);
        }),
          (r = t.sourceList),
          q(o, (e) => {
            io(r, e);
                  ...
                  : AS(t) &&
                    Mn(t).each((n) =>
                      ((e, t, n) => {
                        ...
                        (e.dom.isEmpty(a) || kS.insertAfter(a, t),
                          kS.insertAfter(r, t));
    ...
    TS = (e, t) => {
      const n = To(
          ((e) => {
            const t = ((e) => {
                const t = oS(e, e.selection.getStart()),
                  n = Y(e.selection.getSelectedBlocks(), Lx);
                return t.toArray().concat(n);
              })(e),
              n = ((e) => {
                const t = e.selection.getStart();
                return e.dom.getParents(t, 'ol,ul', nS(e, t));
              })(e);
            return Z(n, (e) => {
              return (
                (t = mn.fromDom(e)),
                Ln(t).exists(
                  (e) =>
                    Mx(e.dom) &&
                    qn(e).exists((e) => !Px(e.dom)) &&
                    Wn(e).exists((e) => !Px(e.dom))
                )
              );
              var t;
            }).fold(
      ...
      if (n.length || o.length) {
        ...
        (_S(e, n, t),
          ...
          e.selection.setRng(qx(e.selection.getRng())),
          e.nodeChanged(),
          (r = !0));
      }
      return r;
    ...
    OS = (e, t) =>
      !((e) => {
        const t = Jx(e);
        return aS(e, t) || !e.selection.isEditable();
      })(e) && TS(e, t),
    BS = (e) => OS(e, 'Indent'),
    PS = (e) => OS(e, 'Outdent'),
    LS = (e) => OS(e, 'Flatten'),
    ...
    FS = (e, t, n) => {
      (((e, t, n) => {
        ...
        ((e, t, n) => {
          (IS(t, n['list-attributes']),
            dn.each(e.select('li', t), (e) => {
              IS(e, n['list-item-attributes']);
            }));
        })(e, t, n));
    },
    US = (e, t) => C(t) && !zx(t, e.schema.getBlockElements()),
    zS = (e, t, n, o) => {
      let r = t[n ? 'startContainer' : 'endContainer'];
      const s = t[n ? 'startOffset' : 'endOffset'];
      (Bx(r) && (r = r.childNodes[Math.min(s, r.childNodes.length - 1)] || r),
        !n && Fx(r.nextSibling) && (r = r.nextSibling));
      const a = (t, n) => {
        var r;
        const s = new Hr(
            t,
      ...
      if (n && Ox(r))
        if (ct(r.textContent)) r = a(r, !1).getOr(r);
          ...
          for (
            null !== r.parentNode && US(e, r.parentNode) && (r = r.parentNode);
            null !== r.previousSibling &&
            (US(e, r.previousSibling) || Ox(r.previousSibling));
      ...
      if (!n && Ox(r))
        if (ct(r.textContent)) r = a(r, !0).getOr(r);
          ...
          for (
            null !== r.parentNode && US(e, r.parentNode) && (r = r.parentNode);
            null !== r.nextSibling &&
            (US(e, r.nextSibling) || Ox(r.nextSibling));
    ...
    jS = (e, t, n) => {
        ...
        l = Y(
          ((e, t, n) => {
            ...
            return (
              dn.each(l, (t) => {
                var s;
                if (Ux(e, t)) return (o.push(t), void (i = null));
                if (r.isBlock(t) || Fx(t))
                  return (Fx(t) && r.remove(t), void (i = null));
                const a = t.nextSibling;
                ag.isBookmarkNode(t) &&
                (Px(a) || Ux(e, a) || (!a && t.parentNode === n))
                  ? (i = null)
                  : (i ||
                      ((i = r.create('p')),
                      null === (s = t.parentNode) ||
      ...
      (dn.each(l, (o) => {
        ...
        e.selection.setRng(Yx(i)));
    },
    $S = (e, t, n) => {
      return (
        ((e, t) => Px(e) && e.nodeName === (null == t ? void 0 : t.nodeName))(
          t,
          n
        ) &&
        ((e, t, n) =>
    ...
    KS = (e, t, n) => {
      ...
      const r = ((e) => {
          ...
          return ((e, t) => C(e) && 1 === t.length && t[0] === e)(t, n)
            ? ((e) => Y(e.querySelectorAll(Zx), Px))(t)
            : Y(n, (e) => Px(e) && t !== e);
        })(e),
        s = f(n) ? n : {};
      r.length > 0
        ? ((e, t, n, o, r) => {
            const s = Px(t);
            if (!s || t.nodeName !== o || WS(r) || sS(t)) {
              jS(e, o, r);
              const a = Kx(e.selection.getRng()),
                i = s ? [t, ...n] : n,
                l = s && sS(t) ? qS : VS;
              (dn.each(i, (t) => {
                l(e, t, o, r);
              }),
                e.selection.setRng(Yx(a)));
            } else LS(e);
          })(e, o, r, t, s)
        : ((e, t, n, o) => {
            if (t !== e.getBody())
              if (t)
                if (t.nodeName !== n || WS(o) || sS(t)) {
                  ...
                  (HS(e.dom, s),
                    e.selection.setRng(Yx(r)),
                    jS(e, n, o),
                    lS(e, MS(n), s));
                } else LS(e);
              else (jS(e, n, o), lS(e, MS(n), t));
          })(e, o, t, s);
    },
    YS = (e, t, n, o) => {
      let r = t.startContainer;
      const s = t.startOffset;
      if (Ox(r) && (n ? s < r.data.length : s > 0)) return r;
      const a = e.schema.getNonEmptyElements();
      Bx(r) && (r = Xg.getNode(r, s));
      const i = new Hr(r, o);
      n &&
        ((e, t) =>
          !!Fx(t) && e.isBlock(t.nextSibling) && !Fx(t.previousSibling))(
          e.dom,
          r
        ) &&
        i.next();
      ...
      for (; (r = l()); ) {
        ...
        if (Ox(r) && r.data.length > 0) return r;
      }
      return null;
    },
    GS = (e, t) => {
      const n = t.childNodes;
      return 1 === n.length && !Px(n[0]) && e.isBlock(n[0]);
    },
    XS = (e, t, n) => {
      let o;
      const r = GS(e, n) ? n.firstChild : n;
      if (
        (((e, t) => {
          var n;
          GS(e, t) &&
    ...
    QS = (e, t, n) => {
      ...
      if (!Hx(e, t) || !Hx(e, n)) return;
      (Px(n.lastChild) && (o = n.lastChild),
        r === n.lastChild &&
          Fx(r.previousSibling) &&
          e.remove(r.previousSibling));
      const s = n.lastChild;
      (s && Fx(s) && t.hasChildNodes() && e.remove(s),
        $x(e, n, !0) && So(mn.fromDom(n)),
        XS(e, t, n),
        o && n.appendChild(o));
      const a = yn(mn.fromDom(n), mn.fromDom(t)) ? e.getParents(t, Px, n) : [];
      (e.remove(t),
        q(a, (t) => {
          $x(e, t) && t !== e.getRoot() && e.remove(t);
        }));
    },
    ZS = (e, t) => {
      const n = e.dom,
      ...
      if (a) {
        ...
        if (r === e.getBody() && $x(n, r)) return !0;
        const i = qx(o.getRng()),
          l = n.getParent(YS(e, i, t, s), 'LI', s),
    ...
    s_ = (e, t, n) => {
      const o = ch(n, t);
      return Z(o.reverse(), (t) => Rs(e, t)).each(_o);
    },
    a_ = (e, t, n, o, r) => {
      if (Rs(o, n)) return (Fi(n), Iu(n.dom));
      ((e, t) => 0 === Y(jn(t), (t) => !Rs(e, t)).length)(o, r) &&
        Rs(o, t) &&
        io(r, mn.fromTag('br'));
    ...
    d_ = (e, t, n, o) => (
      ...
      ((e, t) =>
        yn(t, e)
          ...
          : I.none())(t, n).fold(D(i_, e, t, n, o), D(a_, e, t, n, o))
    ),
    c_ = (e, t, n, o, r) => (t ? d_(e, o, n, r) : d_(e, n, o, r)),
    m_ = (e, t) => {
      const n = mn.fromDom(e.getBody()),
        o = ((e, t, n, o) =>
          o.collapsed
            ? ((e, t, n, o) => {
                const r = n_(t, Ul.fromRangeStart(o)),
                  s = r.bind((o) =>
                    Tu(n, t, o.position).bind((o) =>
                      n_(t, o).map((o) =>
                        ((e, t, n, o) =>
                          ms(o.position.getNode()) && !Rs(e, o.block)
                            ? Pu(!1, o.block.dom)
                                .bind((e) =>
                                  e.isEqual(o.position)
                                    ? Tu(n, t, e).bind((e) => n_(t, e))
                                    : I.some(o)
                                )
                                .getOr(o)
                            : o)(e, t, n, o)
                ...
                return je(r, s, t_).filter(
                  (e) =>
                    ((e) => !vn(e.from.block, e.to.block))(e) &&
                    ((e, t) => {
                      const n = mn.fromDom(e);
                      return vn(o_(n, t.from.block), o_(n, t.to.block));
                    })(t, e) &&
                    ((e) =>
          ...
          (o) => () => {
            c_(n, t, o.from.block, o.to.block, e.schema).each((t) => {
    ...
    f_ = (e) => {
      ...
      return ((e, t) => {
        ...
        return (
          !((e, t) => u_(e, t.startContainer) || u_(e, t.endContainer))(e, t) &&
          n &&
          o
        );
    ...
    g_ = (e, t) => (e.selection.isCollapsed() ? I.none() : f_(e)),
    p_ = (e, t, n, o, r) => I.from(t._selectionOverrides.showCaret(e, n, o, r)),
    h_ = (e, t) =>
      ...
      t.collapsed
        ? ((e, t, n) => {
            const o = mu(1, e.getBody(), t),
              ...
              s = r.getNode();
            if ($m(s)) return p_(1, e, s, !r.isAtEnd(), !1);
            const a = r.getNode(!0);
            if ($m(a)) return p_(1, e, a, !1, !1);
            const i = Ub(e.dom.getRoot(), r.getNode());
            return $m(i) ? p_(1, e, i, !1, n) : I.none();
          })(e, t, n).getOr(t)
        : t,
    v_ = (e) => ih(e) || oh(e),
    y_ = (e) => lh(e) || rh(e),
    C_ = (e, t, n, o, r, s) => {
      (p_(o, e, s.getNode(!r), r, !0).each((n) => {
        if (t.collapsed) {
    ...
    w_ = (e, t) =>
      ((e, t) => {
        ...
        if (a(d)) return I.some(() => C_(e, n, i.getNode(), o, t, d));
        const c = s(d);
        return c && a(c) && hu(d, c)
          ? I.some(() => C_(e, n, i.getNode(), o, t, c))
          : I.none();
      })(e, t),
    E_ = (e, t) => {
      const n = e.getBody();
    ...
    x_ = (e) => {
      ...
      return (
        !t.collapsed &&
        (E_(e, !0).exists((e) => e.isEqual(Ul.fromRangeStart(t))) ||
          E_(e, !1).exists((e) => e.isEqual(Ul.fromRangeEnd(t))))
      );
    },
    S_ = ke([
      { remove: ['element'] },
            ...
            : (t && ps(r.getNode())) || (!t && ps(r.getNode(!0)))
              ? ((e, t, n, o, r) => {
                  ...
                  return lb(mn.fromDom(t), mn.fromDom(o.getNode()))
                    .map((t) =>
                      Rs(e, t) ? S_.remove(t.dom) : S_.moveToElement(s)
                    )
                    .orThunk(() => I.some(S_.moveToElement(s)));
                })(o, e, t, n, r)
              : (t && lh(n)) || (!t && ih(n))
                ? I.some(S_.moveToPosition(r))
                : I.none()
        );
        var s;
      }),
    k_ = (e, t) => I.from(Ub(e.getBody(), t)),
    N_ = (e, t) => {
          ...
          () =>
            ((e, t, n, o) => {
              const r = mu(t ? 1 : -1, e, n),
                ...
                a = mn.fromDom(e);
              return !t && lh(s)
                ? I.some(S_.remove(s.getNode(!0)))
                : t && ih(s)
                  ? I.some(S_.remove(s.getNode()))
                  : !t && ih(s) && Eh(a, s, o)
                    ? xh(a, s, o).map((e) => S_.remove(e.getNode()))
                    : t && lh(s) && wh(a, s, o)
                      ? Sh(a, s, o).map((e) => S_.remove(e.getNode()))
                      : ((e, t, n, o) =>
                          ((e, t) => {
                            const n = t.getNode(!e),
                              o = e ? 'after' : 'before';
                            ...
                            ? ((e, t) =>
                                y(t)
                                  ? I.none()
                                  : e && ps(t.nextSibling)
                                    ? I.some(S_.moveToElement(t.nextSibling))
                                    : !e && ps(t.previousSibling)
                                      ? I.some(
                                          S_.moveToElement(t.previousSibling)
                                        )
                            ...
                            : __(e, t, n, o).bind((t) =>
                                ((e, t, n) =>
                                  n.fold(
                                    (e) => I.some(S_.remove(e)),
                                    (e) => I.some(S_.moveToElement(e)),
                                    (n) =>
                                      ru(t, n, e)
                                        ? I.none()
                                        : I.some(S_.moveToPosition(n))
                                  ))(e, n, t)
                              ))(e, t, s, o);
    ...
    D_ = (e) => e.hasOwnProperty('text'),
    T_ = (e) => e.hasOwnProperty('marker'),
    O_ = (e, t) => {
      const n = (e, n) => {
          if (ss(e)) return { text: e, offset: n };
          {
            const o = t(),
              r = e.childNodes;
            return n < r.length
  ...
  const uk = (e, t) => (-1 === e ? oe(t) : t),
    ...
    kk = (e, t) => vk(Ek(e, t), t),
    Nk = ps,
    Ak = (e, t) => Math.abs(e.left - t),
    Rk = (e, t) => Math.abs(e.right - t),
    Dk = (e, t) =>
      bt(e, (e, n) => {
        const o = Math.min(Ak(e, t), Rk(e, t)),
          r = Math.min(Ak(n, t), Rk(n, t));
  ...
  const Pk = (e, t, n, o, r, s) => {
    ...
    $k = (e, t, n, o, r, s) => {
      ...
      if (d(c)) return h_(e, c.getNode(!a));
      let m = l(c);
      const u = Ji(n);
      if (!m) return u ? I.some(n) : I.none();
      if (((m = tb(a, m)), d(m))) return p_(t, e, m.getNode(!a), a, !1);
      const f = l(m);
      return f && d(f) && hu(m, f)
        ? p_(t, e, f.getNode(!a), a, !1)
        : u
          ? jk(e, m.toRange(), !1)
          : I.none();
    },
    ...
    rN = (e, t, n) => {
      if (e.selection.isCollapsed() && vc(e)) {
        const o = Ul.fromRangeStart(e.selection.getRng());
        return ((e, t, n, o) => {
    ...
    mN = (e) => ss(e.startContainer),
    uN = (e) => {
      const t = e.selection.getRng();
      return (
        ((e) => 0 === e.startOffset && mN(e))(t) &&
        ((e, t) => {
          const n = t.startContainer.parentElement;
          return !h(n) && uv(e, mn.fromDom(n));
        })(e, t) &&
        ((e) =>
          ((e) =>
            ((e) => {
    ...
    gN = (e) => (
      ((e) => {
        ...
        return (
          t.collapsed &&
          (mN(t) || e.dom.isEmpty(t.startContainer)) &&
          !((e) => {
            return (
      ...
      e.selection.isCollapsed()
        ? ((e, t) => {
            ...
            return n(o)
              ...
              : I.from(tb(t, o))
                  .filter((e) => n(e) && hu(o, e))
                  .bind((n) => pN(e, t, n.getNode(!t)));
          })(e, t)
        : ((e, t) => {
            const n = e.selection.getNode();
            return Cs(n) ? pN(e, t, n) : I.none();
          })(e, t),
    bN = (e) => rt(null != e ? e : '').getOr(0),
    vN = (e, t) =>
    ...
    xN = (e) => EN(e, 'outdent'),
    SN = (e) => {
      if (e.selection.isCollapsed() && yN(e)) {
        const t = e.dom,
    ...
    kN = (e, t, n) =>
      me(
        [SN, R_, w_, (e, n) => rN(e, t, n), m_, Fb, L_, hN, g_, fN, P_, _N],
        (t) => t(e, n)
    ...
    NN = (e, t) => {
      (kN(e, t, !1).fold(() => {
        ...
        JS(e) && Xx(e.dom, e.getBody()));
    },
    AN = (e) =>
      void 0 === e.touches || 1 !== e.touches.length
        ? I.none()
        : I.some(e.touches[0]),
    RN = (e, t) => Se(e, t.nodeName),
    DN = (e, t) =>
      !!ss(t) ||
      (!!Xr(t) &&
        !(RN(e.getBlockElements(), t) || Ju(t) || Ks(e, t) || Bs(t) || ys(t))),
    TN = (e, t) => {
      if (ss(t)) {
    ...
    ON = (e) => e.dom.create(Ld(e), Md(e)),
    BN = (e, t, n) => {
      const o = mn.fromDom(ON(e)),
        r = Ii();
      (mo(o, r), n(t, o));
      const s = document.createRange();
      return (s.setStartBefore(r.dom), s.setEndBefore(r.dom), s);
    },
    PN = (e) => (t) => -1 !== (' ' + t.attr('class') + ' ').indexOf(e),
    LN = (e, t, n) =>
      function (o) {
        const r = arguments,
          s = r[r.length - 2],
    ...
    FN = (e, t) => {
      ...
      if (n)
        return 'compositionstart' === t.type
          ? (t.preventDefault(), t.stopPropagation(), void IN(e, n))
          : void (Ki(n) && (IN(e, n), e.undoManager.add()));
    },
    UN = ps,
    zN = (e, t, n) => {
    ...
    jN = (e, t) =>
      ((e, t) => {
        const n = t ? 1 : -1,
          o = e.selection.getRng();
        return ((e, t, n) => $k(t, e, n, ih, lh, UN))(n, e, o).orThunk(
          () => (zN(e, n, o), I.none())
        );
      })(
        e,
      ...
      ((e, t) => {
        ...
        return ((e, t, n) =>
          Hk(
            ...
            (e) => lh(e) || ah(e),
            UN
          ))(n, e, o).orThunk(() => (zN(e, n, o), I.none()));
      })(e, t).exists((t) => (zk(e, t), !0)),
    HN = (e, t) => qk(e, t, t ? lh : ih),
    VN = (e, t) =>
      E_(e, !t)
        .map((n) => {
          const o = n.toRange(),
      ...
      ((e, t) =>
        t
          ...
          : I.from(e.dom.getParent(e.selection.getNode(), 'summary'))
              ...
              .getOr(!1))(e, t),
    YN = { shiftKey: !1, altKey: !1, ctrlKey: !1, metaKey: !1, keyCode: 0 },
    GN = (e, t) =>
      t.keyCode === e.keyCode &&
    ...
    tA = (e, t) => qk(e, t, t ? rh : oh),
    nA = (e, t, n) =>
      te(Hn(e), (e) => (hn(e, t) ? (n(e) ? [e] : []) : nA(e, t, n))),
    oA = (e, t) => dr(e, 'table', t),
    rA = ke([
      { none: ['current'] },
      { first: ['current'] },
    ...
    sA = { ...rA, none: (e) => rA.none(e) },
    aA = (e, t, n, o, r = M) => {
      const s = 1 === o;
      if (!s && n <= 0) return sA.first(e[0]);
      if (s && n >= e.length - 1) return sA.last(e[e.length - 1]);
      {
        const s = n + o,
          a = e[s];
  ...
  const dA = (e, t) => ({ element: e, offset: t }),
    cA = (e, t) => {
      if (e.property().isText(t)) return dA(t, e.property().getText(t).length);
      {
    ...
    fA = {
      ...
      property: N({
        ...
        getText: er,
        setText: tr,
        isBoundary: (e) => !!Nn(e) && ('body' === En(e) || $(lA, En(e))),
    ...
    CA = (e) => {
      const t = e;
      return I.from(t[pA]).exists((e) => 0 === e);
    };
  const wA = Pe('mode'),
    EA = (e) => (t) => {
      t[wA] = e;
    ...
    NA = (e) => (t) => {
      const n = t;
      return I.from(n[wA]).exists((t) => t === e);
    },
    AA = NA(0),
    RA = NA(1),
    DA = ['none', 'copy', 'link', 'move'],
    TA = [
      'none',
      'copy',
      'copyLink',
      ...
      if (t && UA(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            ...
            .orThunk(() =>
              le(n.getClientRects()).bind((n) => bk(Ek(e, Ul.after(t)), n.left))
            )
    ...
    WA = (e, t, n) =>
      n.fold(
        ...
        (n) =>
          !e.mode.isReadOnly() &&
          KA(n) &&
          ((e) => XA(e) || Fn(e).some((e) => kn(e) && XA(e)))(n)
            ? (e.execCommand('mceTableInsertRowAfter'), YA(e, t, n))
            : I.none()
      ),
    KA = (e) => sr(e, Tn('table')).exists(vr),
    YA = (e, t, n) => {
      return WA(
        e,
        t,
    ...
    JA = (e, t) => ({ container: e, offset: t }),
    eR = li.DOM,
    tR = (e) => (t) => (e === t ? -1 : 0),
    nR = (e, t, n) => {
      if (ss(e) && t >= 0) return I.some(JA(e, t));
      {
        const o = Ai(eR);
        return I.from(o.backwards(e, t, tR(e), n)).map((e) =>
          JA(e.container, e.container.data.length)
        );
      }
    },
    oR = (e, t, n) => {
      ...
      const o = e.data;
      if (t >= 0 && t <= o.length) return I.some(JA(e, t));
      {
        const o = Ai(eR);
        return I.from(o.backwards(e, t, tR(e), n)).bind((e) => {
          const o = e.container.data;
          return oR(e.container, t + o.length, n);
        });
      }
    },
    rR = (e, t, n) => {
      if (!ss(e)) return I.none();
      const o = e.data;
      if (t <= o.length) return I.some(JA(e, t));
      {
        const r = Ai(eR);
        return I.from(r.forwards(e, t, tR(e), n)).bind((e) =>
          rR(e.container, t - o.length, n)
        );
      }
    },
    sR = (e, t, n, o, r) => {
    ...
    lR = (e, t, n, o = !1) => {
      ...
      return sR(
        ...
        return 0 !== r.lastIndexOf(n)
          ? I.none()
          : I.some({ text: iR(r, n), range: o, trigger: n });
      });
    },
    dR = (e) => {
      if (((e) => 3 === e.nodeType)(e)) return JA(e, e.data.length);
      {
        ...
        i = Y(
          ...
          (t) =>
            ...
            t.matches.getOrThunk(() =>
              ((e) => (t) => {
                const n = cR(t.startContainer, t.startOffset);
                return !((e, t) => {
                  var n;
                  const o =
  ...
  const fR = (e, t, n) => (e.stype === uR.Error ? t(e.serror) : n(e.svalue)),
    gR = (e) => ({ stype: uR.Value, svalue: e }),
    pR = (e) => ({ stype: uR.Error, serror: e }),
    hR = fR,
    bR = (e) =>
      f(e) && fe(e).length > 100
        ? ' removed due to size'
        : JSON.stringify(e, null, 2),
    vR = (e, t) => pR([{ path: e, getErrorInfo: t }]),
    yR = (e) => ({
      extract: (t, n) => {
        return (
          (o = e(n)),
          (r = (e) => ((e, t) => vR(e, N(t)))(t, e)),
          o.stype === uR.Error ? r(o.serror) : o
        );
        var o, r;
      },
      toString: N('val')
    ...
    ER = (e, t) =>
      yR((n) => {
        const o = typeof n;
        return e(n) ? gR(n) : pR(`Expected type: ${t} but got: ${o}`);
      }),
    xR = ER(E, 'number'),
    SR = ER(u, 'string');
  ER(b, 'boolean');
  const _R = ER(w, 'function'),
    kR = (e) => {
      ...
      switch ({}.toString.call(e).slice(8, -1)) {
        ...
        case 'Array':
        case 'Object':
          return Object.keys(e).every((t) => kR(e[t]));
        default:
          return !1;
      }
    };
  yR((e) =>
    kR(e)
      ? gR(e)
      : pR('Expected value to be acceptable for sending via postMessage')
  );
  const NR = (e) => ({ tag: 'defaultedThunk', process: N(e) }),
    AR = (e, t, n) => {
      switch (e.tag) {
        case 'field':
    ...
    RR = (e) => {
      ...
      return t.errors.length > 0
        ? ((n = t.errors), _(pR, ee)(n))
        : gR(t.values);
      var n;
    },
    DR = (e, t, n, o) => o(xe(e, t).getOrThunk(() => n(e))),
    TR = (e, t, n, o, r) => {
          ...
          e.fold(
            ...
            (e) => {
              ...
              return (
                ...
                (a = I.some),
                s.stype === uR.Value
                  ? { stype: uR.Value, svalue: a(s.svalue) }
                  : s
              );
              var s, a;
            }
    ...
    BR = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) =>
            e.stype === uR.Error
              ? { stype: uR.Error, serror: t(e.serror) }
              : e)(t.extract([e], n), (e) => ({ input: n, errors: e })))(
          e,
          t,
          n
        )),
        fR(o, De.error, De.value)
      );
      var o;
    },
    PR = (e) =>
    ...
    MR = (e, t) => LR(e, e, { tag: 'required', process: {} }, t),
    IR = (e) => MR(e, SR),
    FR = (e) => MR(e, _R),
    UR = (e, t) => LR(e, e, { tag: 'option', process: {} }, t),
    zR = (e) => UR(e, SR),
    jR = (e, t, n) => LR(e, e, NR(t), n),
    $R = (e, t) => jR(e, t, xR),
    HR = IR('type'),
    VR = FR('fetch'),
    qR = FR('onAction');
  ...
  const WR = OR([
    ...
    jR(
      ...
      {
        extract: (e, t) => {
          const n = V(t, (t, n) => YR.extract(e.concat(['[' + n + ']']), t));
          return RR(n);
        },
        toString: () => 'array(' + YR.toString() + ')'
      })
    ))
  ]);
  var KR, YR;
  const GR = (e) => {
        ...
        s = it(() =>
          ((e) => {
            const t = e.ui.registry.getAll().popups,
              n = he(t, (e) => {
                return ((t = e), BR('Autocompleter', WR, t)).fold((e) => {
        ...
        a = (a) => {
          ((n) =>
            t
              .get()
              .map((t) =>
                lR(e.dom, e.selection.getRng(), t.trigger, !0).bind((t) =>
                  mR(e, s, t, n)
                )
              )
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng();
                  return ((e, t, n) => me(n.triggers, (n) => lR(e, t, n)))(
                    e.dom,
                    o,
                    n
                  ).bind((n) => mR(e, t, n));
    ...
    XR = Gt().browser.isSafari(),
    QR = (e) => Fi(mn.fromDom(e)),
    ZR = (e, t) => {
      var n;
      return (
        0 === e.startOffset &&
    ...
    JR = (e, t) => I.from(e.getParent(t.container(), 'details')),
    eD = (e, t) => JR(e, t).isSome(),
    tD = (e, t) => {
      const n = t.getNode();
      ...
      if ('character' === n) {
        ...
        return (
          !!(
            l &&
            (t ? c : d) &&
            Ou(!t, s, n).exists((e) => eD(o, e) && !ze(i, JR(o, e)))
          ) ||
          Ou(t, s, n).fold(L, (n) => {
            const r = JR(o, n);
            if (eD(o, n) && !ze(i, r)) {
    ...
    dD = Gt(),
    cD = dD.os,
    mD = cD.isMacOS() || cD.isiOS(),
    uD = dD.browser.isFirefox(),
    fD = (e, t) => {
      const n = e.dom,
    ...
    bD = (e, t) => {
      Ld(e).toLowerCase() === t.tagName.toLowerCase() &&
        ((e, t, n) => {
          const o = e.dom;
          I.from(n.style)
            .map(o.parseStyle)
    ...
    vD = (e, t, n, o, r = !0, s, a) => {
      ...
      return (bD(e, f), hD(g), f);
    },
    yD = (e, t) => {
      const n = null == e ? void 0 : e.parentNode;
      return C(n) && n.nodeName === t;
    },
    CD = (e) => C(e) && /^(OL|UL|LI)$/.test(e.nodeName),
    wD = (e) => C(e) && /^(LI|DT|DD)$/.test(e.nodeName),
    ED = (e) => {
      const t = e.parentNode;
      return wD(t) ? t : e;
    },
    ...
    _D = (e, t) => t && 'A' === t.nodeName && e.isEmpty(t),
    kD = (e, t) =>
      e.nodeName === t ||
      ...
      insert: (e, t) => {
        ...
        E ||
          (n = ((e, t, n, o, r) => {
            var s, a;
            const i = e.dom,
              l = null !== (s = gD(i, o)) && void 0 !== s ? s : i.getRoot();
        ...
        if (/^(LI|DT|DD)$/.test(r) && Xr(s) && i.isEmpty(_))
          return void ((e, t, n, o, r) => {
            ...
            var l;
            CD((l = n)) && CD(l.parentNode) && (r = 'LI');
            const d = wD(o) ? SD(o) : void 0;
            let c = wD(o) && d ? t(r, { style: SD(o) }) : t(r);
            if (xD(n, o, !0) && xD(n, o, !1))
              if (yD(n, 'LI')) {
                const e = ED(n);
                (s.insertAfter(c, e),
                  ((e) => {
              ...
              (yD(n, 'LI')
                ? (s.insertAfter(c, ED(n)),
                  c.appendChild(s.doc.createTextNode(' ')),
                  c.appendChild(n))
                : i.insertBefore(c, n),
                s.remove(o));
            else if (xD(n, o, !1)) (s.insertAfter(c, ED(n)), s.remove(o));
            else {
              n = ED(n);
        ...
        if (!(p || (_ !== e.getBody() && ND(i, _)))) return;
        ...
        if (p)
          ((A = b(c)),
            ...
            e.selection.setCursorLocation(A, 0));
        else if (Vi(_))
          ...
          const t = ((e) => {
            ...
            return (
              t.setStart(
                e.startContainer,
                AD(!0, e.startContainer, e.startOffset)
              ),
              t.setEnd(e.endContainer, AD(!1, e.endContainer, e.endOffset)),
              t
            );
          })(d).cloneRange();
          t.setEndAfter(_);
          ...
          (((e) => {
            ...
            (A = n.firstChild),
            _ === A ? C(N) && i.insertAfter(n, N) : i.insertAfter(n, _),
            ((e, t, n) => {
              var o;
              const r = [];
              if (!n) return;
            ...
            i.isEmpty(_) && hD(_),
            A.normalize(),
            i.isEmpty(A) ? (i.remove(A), w()) : (bD(e, A), fD(e, A)));
        }
    ...
    OD = (e, t) => {
      BD(e.getBody(), t) || lo(mn.fromDom(t), mn.fromTag('br'));
      const n = mn.fromTag('br');
      (lo(mn.fromDom(t), n), DD(e, n.dom, !1), e.undoManager.add());
    },
    BD = (e, t) => {
      return (
        (n = Ul.after(t)),
    ...
    PD = (e) => e && 'A' === e.nodeName && 'href' in e,
    LD = (e) => e.fold(L, PD, PD, L),
    MD = (e, t) => {
      t.fold(S, D(TD, e), D(OD, e), S);
    },
    ID = {
      insert: (e, t) => {
        const n = ((e) => {
          ...
          return nk(t, e.getBody(), n).filter(LD);
        })(e);
        n.isSome()
          ? n.each(D(MD, e))
          : ((e, t) => {
    ...
    $D = (e, t) => (n, o) => {
      const r =
        ((e) => pD(e).fold(N(''), (e) => e.nodeName.toUpperCase()))(n) ===
        e.toUpperCase();
      return r === t;
    },
    HD = (e) => {
      const t = gD(e.dom, e.selection.getStart());
      return y(t);
    },
    VD = (e) => $D('pre', e),
    qD = (e) => (t, n) => Pd(t) === e,
    WD = (e, t) => ((e) => FD(e, Fd(e)))(e),
    KD = (e, t) => t,
    YD = (e) => {
      const t = Ld(e),
        n = gD(e.dom, e.selection.getStart());
    ...
    QD = (e, t, n) => {
      if (!t.mode.isReadOnly()) {
        if (
          ...
          C(n) && lD(t, e.fakeEventName).isDefaultPrevented())
        )
          return;
        ...
        r = ((e, t) =>
          W_(
            [
              XD([zD], UD.none()),
              XD([VD(!0), HD], UD.none()),
              XD([$D('summary', !0)], UD.br()),
              XD([VD(!0), qD(!1), KD], UD.br()),
              XD([VD(!0), qD(!1)], UD.block()),
              XD([VD(!0), qD(!0), KD], UD.block()),
              XD([VD(!0), qD(!0)], UD.br()),
              XD([jD(!0), KD], UD.br()),
              XD([jD(!0)], UD.block()),
              XD([WD], UD.br()),
    ...
    JD = Gt(),
    eT = JD.os.isiOS() && JD.browser.isSafari(),
    tT = (e, t) => {
      var n;
    ...
    nT = Gt(),
    oT = (e) => e.stopImmediatePropagation(),
    rT = (e) => e.keyCode === Bg.PAGE_UP || e.keyCode === Bg.PAGE_DOWN,
    sT = (e, t, n) => {
      (n && !e.get()
        ? t.on('NodeChange', oT, !0)
        : !n && e.get() && t.off('NodeChange', oT),
        e.set(n));
    },
    aT = (e, t) => e === t || e.contains(t),
    iT = (e, t) => {
      const n = t.container(),
        o = t.offset();
      return ss(n)
    ...
    fT = (e) =>
      pm(e)
        ? [
            { keyCode: Bg.TAB, action: XN(ZA, e, !0) },
            { keyCode: Bg.TAB, shiftKey: !0, action: XN(ZA, e, !1) }
          ]
        : [],
    gT = (e) => {
      if ((e.addShortcut('Meta+P', '', 'mcePrint'), GR(e), lE(e)))
        return Ne(null);
      {
        const t = Zk(e);
        return (
            ...
            e.on('beforeinput', (t) => {
              (e.selection.isEditable() &&
                !H(
                  ...
                  (t) =>
                    !((e, t) =>
                      !aT(e.getBody(), t.startContainer) ||
                      !aT(e.getBody(), t.endContainer) ||
                      fp(e.dom, t))(e, t)
                )) ||
                t.preventDefault();
            });
          ...
          ((e) => {
            e.on('keyup compositionstart', D(FN, e));
          })(e),
          ((e, t) => {
            e.on('keydown', (n) => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  ...
                  QN(
                    [
                      { keyCode: Bg.RIGHT, action: XN(jN, e, !0) },
                      { keyCode: Bg.LEFT, action: XN(jN, e, !1) },
                      { keyCode: Bg.UP, action: XN($N, e, !1) },
                      { keyCode: Bg.DOWN, action: XN($N, e, !0) },
                      ...(o
                        ? [
                            {
                              keyCode: Bg.UP,
                        ...
                        : []),
                      { keyCode: Bg.RIGHT, action: XN(VA, e, !0) },
                      { keyCode: Bg.LEFT, action: XN(VA, e, !1) },
                      { keyCode: Bg.UP, action: XN(qA, e, !1) },
                      { keyCode: Bg.DOWN, action: XN(qA, e, !0) },
                      { keyCode: Bg.UP, action: XN(qA, e, !1) },
                      { keyCode: Bg.UP, action: XN(KN, e, !1) },
                      { keyCode: Bg.DOWN, action: XN(KN, e, !0) },
                      { keyCode: Bg.RIGHT, action: XN(JN, e, !0) },
                      { keyCode: Bg.LEFT, action: XN(JN, e, !1) },
                      { keyCode: Bg.UP, action: XN(eA, e, !1) },
                      { keyCode: Bg.DOWN, action: XN(eA, e, !0) },
                      { keyCode: Bg.RIGHT, action: XN(Xk, e, t, !0) },
                      { keyCode: Bg.LEFT, action: XN(Xk, e, t, !1) },
                      {
                        keyCode: Bg.RIGHT,
                        ctrlKey: !o,
                        altKey: o,
                      ...
                      { keyCode: Bg.UP, action: XN(WN, e, !1) },
                      { keyCode: Bg.DOWN, action: XN(WN, e, !0) }
                    ],
                    n
                  ).each((e) => {
                    n.preventDefault();
              ...
              ((n = o.keyCode === Bg.BACKSPACE),
                o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    ...
                    ZN(
                      [
                        { keyCode: Bg.BACKSPACE, action: XN(SN, e) },
                        { keyCode: Bg.BACKSPACE, action: XN(R_, e, !1) },
                        { keyCode: Bg.DELETE, action: XN(R_, e, !0) },
                        { keyCode: Bg.BACKSPACE, action: XN(w_, e, !1) },
                        { keyCode: Bg.DELETE, action: XN(w_, e, !0) },
                        { keyCode: Bg.BACKSPACE, action: XN(rN, e, t, !1) },
                        { keyCode: Bg.DELETE, action: XN(rN, e, t, !0) },
                        { keyCode: Bg.BACKSPACE, action: XN(Fb, e, !1) },
                        { keyCode: Bg.DELETE, action: XN(Fb, e, !0) },
                        { keyCode: Bg.BACKSPACE, action: XN(sD, e, !1, s) },
                        { keyCode: Bg.DELETE, action: XN(sD, e, !0, s) },
                        ...(mD
                          ? [
                              {
                                keyCode: Bg.BACKSPACE,
                                altKey: !0,
                                action: XN(sD, e, !1, a(!0))
                              },
                              {
                                keyCode: Bg.DELETE,
                                altKey: !0,
                                action: XN(sD, e, !0, a(!0))
                              },
                              {
                                keyCode: Bg.BACKSPACE,
                                metaKey: !0,
                                action: XN(sD, e, !1, a(!1))
                              }
                            ]
                          : [
                              {
                        ...
                        { keyCode: Bg.BACKSPACE, action: XN(L_, e, !1) },
                        { keyCode: Bg.DELETE, action: XN(L_, e, !0) },
                        { keyCode: Bg.BACKSPACE, action: XN(hN, e, !1) },
                        { keyCode: Bg.DELETE, action: XN(hN, e, !0) },
                        { keyCode: Bg.BACKSPACE, action: XN(g_, e, !1) },
                        { keyCode: Bg.DELETE, action: XN(g_, e, !0) },
                        { keyCode: Bg.BACKSPACE, action: XN(m_, e, !1) },
                        { keyCode: Bg.DELETE, action: XN(m_, e, !0) },
                        { keyCode: Bg.BACKSPACE, action: XN(fN, e, !1) },
                        { keyCode: Bg.DELETE, action: XN(fN, e, !0) },
                        { keyCode: Bg.BACKSPACE, action: XN(P_, e, !1) },
                        { keyCode: Bg.DELETE, action: XN(P_, e, !0) },
                        { keyCode: Bg.BACKSPACE, action: XN(_N, e, !1) },
                        { keyCode: Bg.DELETE, action: XN(_N, e, !0) }
                      ],
                      n
                    )
                      .filter((t) => e.selection.isEditable())
                      .each((t) => {
                        (n.preventDefault(),
                          lD(e, o).isDefaultPrevented() || (t(), iD(e, o)));
                      });
                  })(e, t, o));
            }),
              e.on('keyup', (t) => {
                (t.isDefaultPrevented() ||
                  ((e, t, n) => {
                    QN(
                      [
                        { keyCode: Bg.BACKSPACE, action: XN(A_, e) },
                        { keyCode: Bg.DELETE, action: XN(A_, e) },
                        ...(mD
                          ? [
                              {
                                keyCode: Bg.BACKSPACE,
            ...
            e.on('keydown', (t) => {
              t.isDefaultPrevented() ||
                ((e, t) => {
                  ZN(
                    [
                      { keyCode: Bg.SPACEBAR, action: XN(mT, e) },
                      { keyCode: Bg.SPACEBAR, action: XN(uT, e) }
                    ],
                    t
                  ).each((n) => {
                    (t.preventDefault(),
                      lD(e, 'insertText', { data: ' ' }).isDefaultPrevented() ||
                        (n(), iD(e, 'insertText', { data: ' ' })));
                  });
                })(e, t);
            });
          })(e),
            ...
            e.on('keydown', (n) => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  ...
                  QN(
                    [
                      { keyCode: Bg.END, action: XN(HN, e, !0) },
                      { keyCode: Bg.HOME, action: XN(HN, e, !1) },
                      ...(o
                        ? []
                        : [
                            {
                      ...
                      { keyCode: Bg.END, action: XN(tA, e, !0) },
                      { keyCode: Bg.HOME, action: XN(tA, e, !1) },
                      { keyCode: Bg.END, action: XN(tN, e, !0, t) },
                      { keyCode: Bg.HOME, action: XN(tN, e, !1, t) }
                    ],
                    n
                  ).each((e) => {
                    n.preventDefault();
              ...
              e.on('keyup', (o) => {
                (o.isDefaultPrevented() ||
                  ((e, t, n) => {
                    QN(
                      [
                        { keyCode: Bg.PAGE_UP, action: XN(tN, e, !1, t) },
                        { keyCode: Bg.PAGE_DOWN, action: XN(tN, e, !0, t) }
                      ],
                      n
                    );
                  })(e, t, o),
                  rT(o) && n.get() && (sT(n, e, !1), e.nodeChanged()));
              }));
          })(e, t),
          t
        );
    ...
    vT = (e) => {
      const t = (t, n) => {
        ...
        n = X(
          e.children(),
          (e, n) => (hT(n) ? [...e, n] : bT(e) || hT(n) ? e : (t(e, n), [])),
          []
        );
      bT(n) || t(n);
    },
      ...
      (((e) => {
        e.on('keydown', (t) => {
          t.keyCode === Bg.BACKSPACE
            ? e_(e, !1) && t.preventDefault()
            : t.keyCode === Bg.DELETE && e_(e, !0) && t.preventDefault();
        });
      })(e),
        ((e) => {
        ...
        ((e) => {
          e.on('PreInit', () => {
            const { parser: t } = e;
            t.addNodeFilter('ul,ol', (e) => q(e, vT));
          });
        })(e),
        ((e) => {
          km(e) &&
            ((e) => {
              e.on('keydown', (t) => {
                t.keyCode !== Bg.TAB ||
                  Bg.metaKeyPressed(t) ||
                  e.undoManager.transact(() => {
                    (t.shiftKey ? PS(e) : BS(e)) && t.preventDefault();
                  });
              });
            })(e);
        })(e));
  ...
  const wT = 'x-tinymce/html',
    ET = N(wT),
    xT = '\x3c!-- ' + wT + ' --\x3e',
    ST = (e) => xT + e,
    _T = (e) => -1 !== e.indexOf(xT),
    kT = '%MCEPASTEBIN%',
    NT = (e) => e.dom.get('mcepastebin'),
    AT = (e) => C(e) && 'mcepastebin' === e.id,
    RT = (e) => e === kT,
    DT = (e, t) => (
      dn.each(t, (t) => {
    ...
    OT = (e, t) => ({ content: e, cancelled: t }),
    BT = (e, t) => (e.insertContent(t, { merge: em(e), paste: !0 }), !0),
    PT = (e) => /^https?:\/\/[\w\-\/+=.,!;:&%@^~(){}?#]+$/i.test(e),
    LT = (e, t, n) =>
      !(e.selection.isCollapsed() || !PT(t)) &&
      ((e, t, n) => (
        e.undoManager.extra(
          () => {
            n(e, t);
    ...
    MT = (e, t, n) =>
      !!((e, t) =>
        PT(t) && H(gm(e), (e) => Qe(t.toLowerCase(), `.${e.toLowerCase()}`)))(
        e,
        t
      ) &&
      ((e, t, n) => (
        ...
        ((e, t, n) => {
          ...
          return e.hasEventListeners('PastePostProcess') &&
            ...
            ? ((e, t, n) => {
                ...
                return OT(r.node.innerHTML, r.isDefaultPrevented());
              })(e, r, n)
            : OT(r, o.isDefaultPrevented());
        })(e, t, n))(e, t, n);
      if (!s.cancelled) {
        const t = s.content,
          n = () =>
            ((e, t, n) => {
              n || !tm(e)
                ? BT(e, t)
                : ((e, t) => {
                    dn.each([LT, MT, BT], (n) => !n(e, t, BT));
                  })(e, t);
            })(e, t, o);
        r
          ? lD(e, 'insertFromPaste', {
              dataTransfer: FT(t)
            }).isDefaultPrevented() || (n(), iD(e, 'insertFromPaste'))
          : n();
      }
    },
    zT = (e, t, n, o) => {
      const r = n || _T(t);
      UT(e, ((e) => e.replace(xT, ''))(t), r, !1, o);
    },
    jT = (e, t, n) => {
    ...
    HT = (e, t) => t in e && e[t].length > 0,
    VT = (e) => HT(e, 'text/html') || HT(e, 'text/plain'),
    qT = (e, t, n) => {
      ...
      if (Yc(e) && o) {
        ...
        if (s.length > 0)
          return (
            ...
            ((r = s),
            Promise.all(
              V(r, (e) => fy(e).then((t) => ({ file: e, uri: t })))
            )).then((t) => {
              (n && e.selection.setRng(n),
                q(t, (t) => {
                  ((e, t) => {
                    my(t.uri).each(({ data: n, type: o, base64Encoded: r }) => {
                      const s = r ? n : btoa(n),
                        a = t.file,
          ...
          (s =
            HT(t, 'text/plain') && i
              ...
              : ((e) => {
                  ...
                  return ((e = DT(e, [/<!\[[^\]]+\]>/g])), i(n.parse(e)), o);
                })(s)),
        RT(s) || (o ? jT(e, s, r) : zT(e, s, a, r)));
    },
    KT = (e, t, n) => {
      (((e, t, n) => {
        let o;
        (e.on('keydown', (e) => {
          ...
          e.on('paste', (r) => {
            ...
            o = !1;
            const a = $T(r.clipboardData);
            (!VT(a) && qT(e, r, t.getLastRng() || e.selection.getRng())) ||
              (HT(a, 'text/html')
                ? (r.preventDefault(), WT(e, a, a['text/html'], s, !0))
                : HT(a, 'text/plain') && HT(a, 'text/uri-list')
                  ? (r.preventDefault(), WT(e, a, a['text/plain'], s, !0))
                  : (t.create(),
                    bg.setEditorTimeout(
                      e,
                      () => {
                        const n = t.getHtml();
                        (t.remove(), WT(e, a, n, s, !1));
                      },
                      0
                    )));
          }));
    ...
    XT = (e) => ({
      html: ST(e.selection.getContent({ contextual: !0 })),
    ...
    eO = /rgb\s*\(\s*([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\s*\)/gi,
    tO = (e) => dn.trim(e).replace(eO, $a).toLowerCase(),
    nO = (e, t, n) => {
      const o = Zc(e);
      if (n || 'all' === o || !Jc(e)) return t;
      const r = o ? o.split(/[, ]/) : [];
      if (r && 'none' !== o) {
        const n = e.dom,
            ...
            remove: () =>
              ((e, t) => {
                ...
                if (NT(e)) {
                  let o;
                  const r = t.get();
                  for (; (o = NT(e)); ) (n.remove(o), n.unbind(o));
        ...
        ((e, t) => {
          (e.addCommand('mceTogglePlainTextPaste', () => {
            ...
            e.addCommand('mceInsertClipboardContent', (t, n) => {
              (n.html && zT(e, n.html, n.internal, !1),
                n.text && jT(e, n.text, !1));
            }));
        })(e, o),
        ((e) => {
          const t = (t) => (n) => {
          ...
          (((e, t) => {
            (e.on(
              ...
              e.on(
                'copy',
                ((e) => (t) => {
                  !t.isDefaultPrevented() && QT(e) && YT(t, XT(e), GT(e), S);
                })(e)
              ));
          })(e, t),
            ((e, t) => {
              (Kc(e) &&
                      ...
                      bg.setEditorTimeout(e, () => {
                        e.undoManager.transact(() => {
                          ((a || (d && l)) && e.execCommand('Delete'),
                            JT(e, o));
                          const t = TT(i);
                          r['text/html'] ? zT(e, t, s, !0) : jT(e, t, !0);
                        });
                      })));
                }),
                e.on('dragstart', (e) => {
                ...
                e.on('dragover dragend', (n) => {
                  (Yc(e) && !t.get() && (n.preventDefault(), JT(e, ZT(e, n))),
    ...
    sO = ss,
    aO = (e) => ps(e.dom),
    iO = (e) => (t) => vn(mn.fromDom(e), t),
    lO = (e, t) => sr(mn.fromDom(e), aO, iO(t)),
    dO = (e, t, n) => {
      const o = new Hr(e, t),
        r = n ? o.next.bind(o) : o.prev.bind(o);
      let s = e;
      for (let t = n ? e : r(); t && !rO(t); t = r()) yl(t) && (s = t);
      return s;
    },
    cO = (e) => {
      const t = ((e, t, n) => {
        ...
        return (
          lO(s, r).fold(
            () => {
              sO(s) ? i.setStart(s, 0) : i.setStartBefore(s);
            },
            (e) => i.setStartBefore(e.dom)
          ),
          lO(a, r).fold(
            () => {
              sO(a) ? i.setEnd(a, a.data.length) : i.setEndAfter(a);
            },
      ...
      e.selection.setRng(ay(t));
    };
  var mO;
  !(function (e) {
    ((e.Before = 'before'), (e.After = 'after'));
  })(mO || (mO = {}));
  const uO = (e, t) => Math.abs(e.left - t),
    fO = (e, t) => Math.abs(e.right - t),
    gO = (e, t) =>
      ((e) =>
        X(
          e,
    ...
    bO = (e, t, n) =>
      ((e, t, n) => {
        ...
        .map((e) =>
          ((e, t) => ({
            node: e.node,
            position: uO(e, t) < fO(e, t) ? mO.Before : mO.After
          }))(e, t)
        ),
    vO = (e) => {
      var t, n;
    ...
    CO = (e, t, n, o) => {
      ...
      return v(o)
        ...
        : ((e, t, n, o) => ({ ...t, dataTransfer: o, type: e, ...yO(n) }))(
            e,
            o,
            t,
            r
            ...
            const s = r.currentTarget === t.getDoc().documentElement,
              l = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
                ...
                ((e, t) => {
                  return (
                    (n = ((e) =>
                      e.inline ? vO(e.getBody()) : { left: 0, top: 0 })(e)),
                    (o = ((e) => {
                      const t = e.getBody();
                      return e.inline
                    ...
                    (r = ((e, t) => {
                      if (t.target.ownerDocument !== e.getDoc()) {
                        const n = vO(e.getContentAreaContainer()),
                          o = ((e) => {
                            const t = e.getBody(),
                  ...
                  (e.intervalId.clear(),
                    e.dragging &&
                      ...
                      (a + 8 >= g
                        ...
                        : a - 8 <= 0
                          ? e.intervalId.set(NO(d))
                          : i + 8 >= p
                            ? e.intervalId.set(kO(d))
                            : i - 8 <= 0
                              ? e.intervalId.set(_O(d))
                              : h + 16 >= window.innerHeight
                                ? e.intervalId.set(AO(window))
                                : h - 16 <= 0
                                  ? e.intervalId.set(NO(window))
                                  : b + 16 >= window.innerWidth
                                    ? e.intervalId.set(kO(window))
                                    : b - 16 <= 0 &&
                                      e.intervalId.set(_O(window))));
                });
              })(
                e.ghost,
                l,
    ...
    OO = (e, t, n) => {
      (e.on((e) => {
        (e.intervalId.clear(),
          e.dragging &&
            n.fold(
              () => DO(t, 'dragend', e.element, e.dataTransfer),
              (n) => DO(t, 'dragend', e.element, e.dataTransfer, n)
            ));
      }),
        BO(e));
    },
    ...
    PO = (e) => {
      const t = We(),
        ...
        r = ((e, t) => (n) => {
          if (((e) => 0 === e.button)(n)) {
            ...
            if (
              C(o) &&
              ((e, t, n) => wO(n) && n !== t && e.isEditable(n.parentElement))(
                t.dom,
                t.getBody(),
                o
              )
              ...
              e.set({
                ...
                ghost: xO(t, o, o.offsetWidth, o.offsetHeight),
                intervalId: qe(100)
              });
            }
          }
              ...
              if (
                ...
                const r =
                  ...
                  void 0 !== o
                    ? o
                    : t.getBody();
                DO(t, 'drop', r, e.dataTransfer, n).isDefaultPrevented() ||
                  t.undoManager.transact(() => {
                    (((e, t) => {
      ...
      (e.on('mousedown', r),
        ...
        e.on('keydown', (n) => {
          n.keyCode === Bg.ESC && OO(t, e, I.none());
        }));
    },
    LO = ps,
    MO = (e, t) => Ub(e.getBody(), t),
    IO = (e) => {
      const t = e.selection,
        n = e.dom,
        o = e.getBody(),
        r = zm(e, o, n.isBlock, () => Dg(e)),
        s = 'sel-' + n.uniqueId(),
        a = 'data-mce-selected';
      let i;
      const l = (e) =>
          ...
          if (r.collapsed) {
            if (!m(r)) {
              const e = c ? 1 : -1,
                ...
                s = t.getNode(!c);
              if (C(s)) {
                if (Hm(s)) return d(e, s, !!c && !t.isAtEnd(), !1);
              ...
              const a = t.getNode(c);
              if (C(a)) {
                if (Hm(a)) return d(e, a, !c && !t.isAtEnd(), !1);
      ...
      return (
        lE(e) ||
          ...
          e.on(
            ...
            (t) => {
              const n = t.target,
                o = MO(e, n);
              LO(o)
                ? (t.preventDefault(), h_(e, o).each(f))
                : l(n) && h_(e, n).each(f);
            },
            !0
          ),
          e.on('mousedown', (r) => {
              ...
              !((e, t, n) => {
                const o = mn.fromDom(e.getBody()),
                  ...
                  s = ((e, t, n, o) => {
                    ...
                    return {
                      x: n - (e ? r.left + t.dom.clientLeft + AE(t) : 0),
                      y: o - (e ? r.top + t.dom.clientTop + NE(t) : 0)
                    };
                  })(e.inline, r, t, n);
                return ((e, t, n) => {
                  const o = _E(e),
            ...
            const a = MO(e, s);
            LO(a)
              ? (r.preventDefault(), h_(e, a).each(f))
              : bO(o, r.clientX, r.clientY).each((n) => {
                  var o;
                  (r.preventDefault(),
                    (o = d(1, n.node, n.position === mO.Before, !1)) &&
                      t.setRng(o),
                    Qr(a) ? a.focus() : e.getBody().focus());
                });
          }),
          e.on('keypress', (e) => {
            Bg.modifierPressed(e) || (LO(t.getNode()) && e.preventDefault());
          }),
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(),
                          'drop' === t.type &&
                            PE(e, 'Dropped file type is not supported'));
                      }
                    },
                    n = (n) => {
                      Sg(e, n.target) && t(n);
              ...
              e.on('focusin', (t) => {
                ...
                if (Cs(n)) {
                  ...
                  e.selection.getNode() !== o &&
                    h_(e, o).each((t) => e.selection.setRng(t));
                }
              });
            });
          })(e)),
    ...
    $O = (e, t) =>
      jO(e, t.start).bind(({ node: n, offset: o }) =>
        jO(e, t.end).map(({ node: e, offset: t }) => {
          const r = document.createRange();
    ...
    qO = (e, t) => I.from(e.dom.getParent(t.startContainer, e.dom.isBlock)),
    WO = (e, t, n) => {
      const o = e.dynamicPatternsLookup({ text: n, block: t });
      return {
        ...e,
        blockPatterns: cd(o).concat(e.blockPatterns),
        inlinePatterns: md(o).concat(e.inlinePatterns)
      };
    },
    KO = (e, t, n, o) => {
      const r = e.createRng();
    ...
    YO = (e, t) => e.create('span', { 'data-mce-type': 'bookmark', id: t }),
    GO = (e, t) => {
      const n = e.createRng();
      return (n.setStartAfter(t.start), n.setEndBefore(t.end), n);
    },
    XO = (e, t, n) => {
      const o = $O(e.getRoot(), n).getOrDie('Unable to resolve path range'),
        r = o.startContainer,
        s = o.endContainer,
      ...
      return {
        prefix: t,
        end: a.parentNode.insertBefore(YO(e, t + '-end'), a),
        start: l.insertBefore(YO(e, t + '-start'), i)
      };
    },
    QO = (e, t, n) => {
      (HO(e, e.get(t.prefix + '-end'), n),
        HO(e, e.get(t.prefix + '-start'), n));
    },
    ZO = (e) => 0 === e.start.length,
    JO = (e, t, n, o) => {
      const r = t.start;
      var s;
      return sR(
        ...
        }
        {
          ...
          return oR(o.container, s, n)
            ...
            .orThunk(() => JO(e, t, n, JA(o.container, 0)));
        }
      });
    },
    eB = (e, t, n, o) => {
      const r = e.dom,
        ...
        l = n.position.offset;
      return oR(i, l - n.pattern.end.length, t).bind((d) => {
        const c = zO(r, s, d.container, d.offset, i, l, o);
        if (ZO(a))
          return I.some({
        ...
        {
          const i = tB(e, n.remainingPatterns, d.container, d.offset, t, o),
          ...
          return u.map((e) => {
            ...
            return {
              ...
              position: JA(e.startContainer, e.startOffset)
            };
          });
        }
      });
    ...
    tB = (e, t, n, o, r, s) => {
      const a = e.dom;
      return nR(n, o, a.getRoot()).bind((i) => {
        const l = KO(a, r, n, o);
        for (let a = 0; a < t.length; a++) {
          const d = t[a];
          ...
          if (m.isNone() && o > 0) return tB(e, t, n, o - 1, r, s);
    ...
    oB = (e, t, n, o, r, s) => {
      ...
      return ((e, t) => {
        ...
        tB(e, r.inlinePatterns, n, o, t, s).fold(
          () => [],
          (e) => e.matches
        ),
        tB(
    ...
    rB = (e, t) => {
        ...
        r = ((e, t) => {
          const n = Pe('mce_textpattern'),
            o = G(
              t,
              (t, o) => {
                const r = XO(e, n + `_end${t.length}`, o.endRng);
      ...
      (q(r, (t) => {
        ...
        (ZO(t.pattern)
          ...
          QO(n, t.endMarker, r),
          QO(n, t.startMarker, r));
      }),
        e.selection.moveToBookmark(o));
    },
    sB = (e, t, n) =>
      ((e, t, n) => {
        if (ss(e) && 0 >= e.length) return I.some(JA(e, 0));
        {
          const t = Ai(eR);
          return I.from(t.forwards(e, 0, tR(e), n)).map((e) =>
            JA(e.container, 0)
          );
        }
      })(t, 0, t).map((o) => {
    ...
    aB = (e) => (t, n) => {
      const o = t.dom,
        r = n.pattern,
        s = $O(o.getRoot(), n.range).getOrDie('Unable to resolve path range');
      return (
        qO(t, s).each((n) => {
          'block-format' === r.type
            ? ((e, t) => {
        ...
        ? e(r.blockPatterns, a)
            .map((e) =>
              t && dn.trim(a).length === e.start.length
                ? []
                : [{ pattern: e, range: zO(l, l.getRoot(), o, 0, o, 0, s) }]
            )
            .getOr([])
        : [];
    },
    ...
    cB = iB((e, t, n) => 0 === t.indexOf(e.start) || 0 === n.indexOf(e.start)),
    mB = lB(cB, !0),
    uB = aB(sB),
    fB = iB((e, t, n) => t === e.start || n === e.start),
    gB = lB(fB, !1),
    pB = (e, t, n) => {
    ...
    hB = (e) => {
                ...
                ((e, t) => {
                  ...
                  return qO(e, n)
                    .map((o) => {
                      ...
                      return {
                        inlineMatches: oB(e, o, n.startContainer, s, a, !0),
                        blockMatches: mB(e, o, a, !0)
                      };
                    })
                    .filter(
                    ...
                    return qO(e, n)
                      .map((o) => {
                        const r = Math.max(0, n.startOffset),
                          s = KO(e.dom, o, n.startContainer, r),
                          a = WO(t, o, s);
                        return gB(e, o, a, !1, s);
                      })
                      .filter((e) => e.length > 0);
            ...
            ((e, t) => {
              ...
              qO(e, n).map((o) => {
                const r = Math.max(0, n.startOffset - 1),
                  s = KO(e.dom, o, n.startContainer, r),
                  a = WO(t, o, s),
                  i = oB(e, o, n.startContainer, r, a, !1);
                i.length > 0 &&
                  e.undoManager.transact(() => {
                    rB(e, i);
                  });
      ...
      (e.on('keyup', (e) => {
        pB(n, e, (e, t) => e === t.keyCode && !Bg.modifierPressed(t)) && s();
      }),
        e.on('keypress', (n) => {
          pB(t, n, (e, t) => e.charCodeAt(0) === t.charCode) &&
        ...
        lE(e)
          ...
          : (e.on('keydown', (t) => {
            ...
            d &&
              ...
              b(),
              e.on('init', () => {
                u('DefaultParagraphSeparator', Ld(e));
              }),
              k(),
              v(),
                    ...
                    s =
                      (null == r
                        ...
                        : r.offsetNode.childNodes[
                          ...
                          ]) || (null == r ? void 0 : r.offsetNode);
                  if (s && 'IMG' === (a = s).nodeName && e.dom.isEditable(a)) {
    ...
    vB = li.DOM,
    yB = (e) => (e.inline ? e.getElement().nodeName.toLowerCase() : void 0),
    CB = (e) => Ce(e, (e) => !1 === v(e)),
    wB = (e) => {
    ...
    xB = (e) => (e.inline ? e.ui.styleSheetLoader : e.dom.styleSheetLoader),
    SB = (e) => {
      const t = xB(e),
        n = ac(e),
        o = e.contentCSS,
      ...
      const a = Promise.all(
          ((e, t, n) => {
            const { pass: o, fail: r } = K(t, (e) =>
                tinymce.Resource.has(sx(e))
              ),
              s = o.map((t) => {
                const n = tinymce.Resource.get(sx(t));
                return u(n)
                  ? Promise.resolve(xB(e).loadRawCss(t, n))
                  : Promise.resolve();
              }),
              a = [...s, xB(e).loadAll(r)];
    ...
    _B = (e) => {
      !0 !== e.removed &&
        (((e) => {
          (lE(e) || e.load({ initial: !0, format: 'html' }),
    ...
    kB = (e) => {
      ...
      let n = e.getDoc();
      e.inline &&
        (vB.addClass(t, 'mce-content-body'),
      ...
      ((o.disabled = !0),
        (e.readonly = Tc(e)),
        (e._editableRoot = Oc(e)),
        !xm(e) &&
          e.hasEditableRoot() &&
          (e.inline &&
            'static' === vB.getStyle(o, 'position', !0) &&
        ...
        (e.selection = gE(e.dom, e.getWin(), e.serializer, e)),
        (e.annotator = sg(e)),
        (e.formatter = Sx(e)),
        (e.undoManager = kx(e)),
        (e._nodeChangeDispatcher = new CT(e)),
        (e._selectionOverrides = IO(e)),
        yT(e),
        ((e) => {
          const t = We(),
            n = Ne(!1),
            ...
            e.on('BeforeSetContent', (t) => {
              ((e, t, n) => {
                let o = t.length,
                  r = n.content;
                if ('raw' !== n.format) {
                  for (; o--; ) r = r.replace(t[o], LN(e, r, im(e)));
                  n.content = r;
                }
              })(e, a, t);
            }),
        ...
        lE(e) ||
          (((e) => {
            e.on('mousedown', (t) => {
              t.detail >= 3 && (t.preventDefault(), cO(e));
            });
          })(e),
          ((e) => {
            hB(e);
          ...
          e.on('NodeChange', () =>
            ((e) => {
              ...
              if (
                ...
                ((e, t, n) =>
                  H(dh(mn.fromDom(n), mn.fromDom(t)), (t) => RN(e, t.dom)))(
                  r,
                  a,
                  s
                )
              ...
              d && (e.selection.setRng(B_(d)), e.nodeChanged());
            })(e)
          );
        })(e),
        ((e) => {
            ...
            s = (t, a) => {
              ...
              const i = e.getBody(),
                l =
                  !((e) =>
                    Rx(e) &&
                    !(Dx(e) || ('keyup' === e.type && 229 === e.keyCode)))(t) &&
                  ((e, t, n) => {
                    if (
              ...
              (('' !== n.getAttrib(i, Ax)) !== l || a) &&
                (n.setAttrib(i, Ax, l ? r : null),
                ((e, t) => {
      ...
      (((e) => {
        ...
        (((e) => {
          ...
          qc(e) ||
            ((t.body.spellcheck = !1), vB.setAttrib(n, 'spellcheck', 'false')),
          (e.quirks = bB(e)),
          ((e) => {
          ...
          (t) => {
            (e.setProgressState(!0),
              SB(e).then(() => {
                t().then(
                  (t) => {
                    (e.setProgressState(!1), _B(e), mE(e));
                  },
                  (t) => {
                    (e.notificationManager.open({
                      type: 'error',
    ...
    NB = li.DOM,
    AB = li.DOM,
    RB = (e, t) => ({ editorContainer: e, iframeContainer: t, api: {} }),
    DB = (e) => {
      const t = e.getElement();
      return e.inline
        ? RB(null)
        : ((e) => {
            const t = AB.create('div');
            return (AB.insertAfter(t, e), RB(t, t));
          })(t);
    },
    TB = async (e) => {
      (e.dispatch('ScriptsLoaded'),
        ((e) => {
          const t = dn.trim(qd(e)),
            n = e.ui.registry.getAll().icons,
            o = { ...wE.get('default').icons, ...wE.get(t).icons };
          pe(o, (t, o) => {
              ...
              if (((n = dn.trim(n)), o && -1 === dn.inArray(t, n))) {
                ...
                try {
                  ...
                  ((e, t, n) => {
                    ...
                    (gd(e, 'PluginLoadError', { message: o }),
                      IE(o, n),
                      PE(e, o));
                  })(e, n, t);
                }
      ...
      (((e, t) => {
        ...
        e.inline
          ...
          : ((e, t) => {
              (((e, t) => {
                const n = rn.browser.isFirefox() ? zc(e) : 'Rich Text Area',
                  o = e.translate(n),
                ...
                ((s.onload = () => {
                  ...
                  (e.iframeElement = s),
                  (e.iframeHTML = ((e) => {
                    let t = Rd(e) + '<html><head>';
                    (Dd(e) !== e.editorManager.documentBaseURL &&
                      (t +=
                  ...
                  NB.add(t.iframeContainer, s));
              })(e, t),
                t.editorContainer &&
                  ((t.editorContainer.style.display = e.orgDisplay),
                  (e.hidden = NB.isHidden(t.editorContainer))),
                (e.getElement().style.display = 'none'),
                NB.setAttrib(e.id, 'aria-hidden', 'true'),
                (e.getElement().style.visibility = e.orgVisibility),
                ((e) => {
                  const t = e.iframeElement,
                    n = () => {
                      ((e.contentDocument = t.contentDocument), kB(e));
                    };
                  if (fm(e) || rn.browser.isFirefox()) {
                    const t = e.getDoc();
    ...
    LB = (e, t) => {
      ...
      (((e, t) => {
        ...
        if (u(n) && !BB(n) && !Se(TE.urls, n)) {
          ...
          TE.load(n, r).catch(() => {
            ((e, t, n) => {
              LE(e, 'ThemeLoadError', ME('theme', t, n));
            })(e, r, n);
          });
        }
      })(e, t),
        ((e, t) => {
          ...
          if ('plugin' !== n && !Se(EE.urls, n)) {
            ...
            EE.load(n, r).catch(() => {
              ((e, t, n) => {
                LE(e, 'ModelLoadError', ME('model', t, n));
              })(e, r, n);
            });
          }
        })(e, t),
        ...
        ((e, t) => {
          ...
          if (!gi.hasCode(n) && 'en' !== n) {
            ...
            e.add(r).catch(() => {
              ((e, t, n) => {
                LE(e, 'LanguageLoadError', ME('language', t, n));
              })(t, r, n);
            });
          }
        })(n, e),
        ((e, t, n) => {
          const o = PB(t, 'default', n),
            r = ((e) =>
              I.from(Wd(e))
                .filter(nt)
          ...
          q(
            ...
            (n) => {
              e.add(n.url).catch(() => {
                ((e, t, n) => {
                  LE(e, 'IconsLoadError', ME('icons', t, n));
        ...
        ((e, t) => {
          const n = (t, n) => {
            'licensekeymanager' !== t &&
              DE.load(t, n).catch(() => {
                ((e, t, n) => {
                  LE(e, 'PluginLoadError', ME('plugin', t, n));
                })(e, n, t);
              });
          };
          (pe(Lc(e), (t, o) => {
            (n(o, t), e.options.set('plugins', Pc(e).concat(o)));
          }),
            q(Pc(e), (e) => {
              !(e = dn.trim(e)) ||
                DE.urls[e] ||
    ...
    IB = (e) => {
      const t = ((e, t, n = 36) => {
        ...
        e,
        (() => {
          const e = Math.floor(Oe() * MB.length);
          return MB[e];
        })()
      );
    ...
    FB = OR([
      LR('id', 'id', { tag: 'required', process: {} }, wR()),
      zR('name'),
      zR('avatar'),
      ((e) => LR(e, e, { tag: 'option', process: {} }, wR()))('custom')
    ]),
    UB = (e) => {
      const t = {};
      return (
    ...
    zB = (e) => {
      ...
      const t = V(e, (e) => BR('Invalid user object', FB, e)),
    ...
    GB = (e, t, n, o, r) => {
      var s;
      const a = e
          ? { mobile: KB(null !== (s = r.mobile) && void 0 !== s ? s : {}, t) }
          : {},
        i = qB(['mobile'], Ie(a, r)),
        l = dn.extend(
          n,
          ...
          ((e, t) => e && WB(t, 'mobile'))(e, i)
            ...
            : {},
          { external_plugins: YB(o, i.options()) }
        );
      return ((e, t, n, o) => {
        const r = VB(n.forced_plugins),
          s = VB(o.plugins),
          a = ((e, t) => (WB(e, t) ? e.sections()[t] : {}))(t, 'mobile'),
          i = ((e, t, n, o) => (e && WB(t, 'mobile') ? o : n))(
            e,
            t,
            s,
            a.plugins ? VB(a.plugins) : s
          ),
          l = ((e, t) => [...VB(e), ...VB(t)])(r, i);
    ...
    ZB = (e, t) => {
      if (e.selection.isEditable()) {
        ...
        XC(e, {
          ...
          const n = ((e, t, n) => dE(e).editor.insertContent(t, n))(
            e,
            t.content,
            o
          );
    ...
    JB = { 'font-size': 'size', 'font-family': 'face' },
    eP = Tn('font'),
    tP = (e) => (t, n) =>
      I.from(n)
        .map(mn.fromDom)
          ...
          ((e, t, n) =>
            Ar(
              ...
              (t) =>
                ((t) =>
                  jo(t, e).orThunk(() =>
                    eP(t) ? xe(JB, e).bind((e) => yo(t, e)) : I.none()
                  ))(t),
              (e) => vn(mn.fromDom(t), e)
            ))(e, t, n.dom).or(
    ...
    dP = (e, t) => {
      ...
      ((e, t, n, o) => {
        ...
        const n = vD(e, s, t.dom, a, !1, l);
        (i(t, mn.fromDom(n)),
          e.selection.setCursorLocation(n, 0),
          e.dispatch('NewBlock', { newBlock: n }),
          iD(e, 'insertParagraph'));
      });
    },
    cP = (e) => {
      (XB(e),
        ...
        ((e) => {
          e.editorCommands.addCommands({
            ...
            insertImage: (t, n, o) => {
              ZB(e, e.dom.createHTML('img', { src: o }));
            },
          ...
          (((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = aP(e, t);
                  (e.formatter.toggle('fontname', { value: iP(n) }),
                    e.nodeChanged());
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  (e.formatter.toggle('fontsize', { value: aP(e, t) }),
                    e.nodeChanged());
                })(e, o);
              },
              LineHeight: (t, n, o) => {
            ...
            ((e) => {
              ...
              (e.editorCommands.addCommands(
                ...
                e.editorCommands.addQueryValueHandler('FontName', () =>
                  ((e) => sP(e, (t) => oP(e.getBody(), t.dom)).getOr(''))(e)
                ),
                e.editorCommands.addQueryValueHandler('FontSize', () =>
                  ((e) => sP(e, (t) => nP(e.getBody(), t.dom)).getOr(''))(e)
                ),
                e.editorCommands.addQueryValueHandler('LineHeight', () =>
                  ((e) =>
                    sP(e, (t) => {
                      const n = mn.fromDom(e.getBody()),
                        o = Ar(t, (e) => jo(e, 'line-height'), D(vn, n));
                      return o.getOrThunk(() => {
                ...
                e.removed ||
                  (t
                    ...
                    : ((e) => {
                        ...
                        (e.inline ||
                          (rn.browser.isOpera() || Rg(n), e.getWin().focus()),
  ...
  class fP {
    ...
    queryCommandState(e) {
      if ((!uP(e) && this.editor.quirks.isHidden()) || this.editor.removed)
        return !1;
      const t = e.toLowerCase(),
  ...
  const hP = (e) => (
      e._eventDispatcher ||
        (e._eventDispatcher = new pP({
          scope: e,
          toggleEvent: (t, n) => {
            pP.isNative(t) && e.toggleNativeEvent && e.toggleNativeEvent(t, n);
          }
        })),
      e._eventDispatcher
    ),
  ...
  const CP = (e, t) => {
      ...
      const n = uc(e);
      return n
        ? (e.eventRoot || (e.eventRoot = vP.select(n)[0]), e.eventRoot)
        : e.getBody();
    },
    wP = (e, t, n) => {
      ((e) => !e.hidden && !ex(e))(e)
        ...
        : ex(e) &&
          ((e, t) => {
            ...
            } else ((e) => $(rx, e.type))(t) && e.dispatch(t.type, t);
          })(e, n);
    },
    EP = (e, t) => {
        ...
        'focus' !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                n.delegates &&
                (n.dom.unbind(CP(n, e), e, n.delegates[e]),
    ...
    _P = (e, t) => e + (ot(t.message) ? '' : `. ${t.message}`),
    kP = (e) => e.valid,
    NP = (e, t, n = '') => {
      const o = t(e);
      return b(o)
          ...
          (((e) => {
            ...
            ((e) => {
              (e.on('ShowCaret ObjectSelected', (t) => {
                ex(e) && t.preventDefault();
              }),
                e.on('DisabledStateChange', (t) => {
                  t.isDefaultPrevented() || nx(e, t.state);
                }));
            })(e));
        })(e),
        {
    ...
    LP = dn.makeMap('alt,ctrl,shift,meta,access'),
    MP = (e) => {
      const t = {},
        n = rn.os.isMacOS() || rn.os.isiOS();
      OP(BP(e.toLowerCase(), '+'), (e) => {
        ((e) => e in LP)(e)
          ? (t[e] = !0)
          : /^[0-9]{2,}$/.test(e)
            ? (t.keyCode = parseInt(e, 10))
            : ((t.charCode = e.charCodeAt(0)),
              (t.keyCode = PP[e] || e.toUpperCase().charCodeAt(0)));
      });
      const o = [t.keyCode];
      let r;
      for (r in LP) t[r] ? o.push(r) : (t[r] = !1);
      return (
        (t.id = o.join(',')),
  ...
  class $P {
    constructor(e, t, n) {
      ...
      ((this.options = ((e, t, n = t) => {
        const o = {},
          ...
          s = (e, t, n) => {
            ...
            return kP(o)
              ? ((r[e] = o.value), !0)
              : (console.warn(
                  _P(`Invalid value passed for the ${e} option`, o)
                ),
                !1);
          },
          a = (e) => Se(o, e);
          ...
          register: (e, n) => {
            const a = ((e) => u(e.processor))(n)
                ? ((e) => {
                    ...
                    return (n) => NP(n, t, `The value must be a ${e}.`);
                  })(n.processor)
                : n.processor,
              i = ((e, t, n) => {
                if (!v(t)) {
                  const o = NP(t, n);
                  if (kP(o)) return o.value;
                  console.error(
                    _P(`Invalid default value passed for the "${e}" option`, o)
                  );
                }
              })(e, n.default, a);
        ...
        ((e) => {
          ...
          (t('id', { processor: 'string', default: e.id }),
            ...
            t('body_id', { processor: Nd(e, 'tinymce'), default: 'tinymce' }),
            t('body_class', { processor: Nd(e), default: '' }),
            ...
            e.on('ScriptsLoaded', () => {
              (t('directionality', {
                ...
                t('placeholder', {
                  processor: 'string',
                  default: xd.getAttrib(e.getElement(), 'placeholder')
                }));
            }),
        ...
        (this.userLookup = ((e) => {
          ...
          return Object.freeze({
            ...
            fetchUsers: (s) => {
              ...
              if (!a)
                return se(s, (e) =>
                  Promise.resolve({ id: e, name: e, avatar: IB(e) })
                );
              ...
              return (
                ...
                X(
                  ...
                  (e, t) => (
                    (e[t] = o(t).getOr(
                      Promise.resolve({ id: t, name: t, avatar: IB(t) })
                    )),
                    e
                  ),
                  {}
      ...
      (l &&
        ...
        ci.ScriptLoader._setCrossOrigin((e) => Jd(o)(e, 'script')),
        li.DOM.styleSheetLoader._setCrossOrigin((e) => Jd(o)(e, 'stylesheet')));
      const d = Bc(o);
      (C(d) && li.DOM.styleSheetLoader._setContentCssCors(d),
        (pi.languageLoad = s('language_load')),
        (pi.baseURL = n.baseURL),
        this.setDirty(!1),
        (this.documentBaseURI = new AC(Dd(o), { base_uri: this.baseUri })),
        (this.baseURI = this.baseUri),
        (this.inline = Sc(o)),
        (this.hasVisual = Ic(o)),
        (this.shortcuts = new IP(this)),
        (this.editorCommands = new fP(this)),
        cP(this));
    ...
    render() {
      ((e) => {
        ...
        gi.setCode(ec(e));
        const n = () => {
          (OB.unbind(window, 'ready', n), e.render());
        };
        if (!Za.Event.domLoaded) return void OB.bind(window, 'ready', n);
        ...
        (e.on('remove', () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) =>
            ea.forElement(e, { contentCssCors: Bc(t), referrerPolicy: Zd(t) }))(
            o,
            e
          )),
          Sc(e)
        ...
        const s = e.getElement().form || OB.getParent(t, 'form');
        (s &&
          ((e.formElement = s),
          _c(e) &&
            !rs(e.getElement()) &&
            (OB.insertAfter(OB.create('input', { type: 'hidden', name: t }), t),
            (e.hasHiddenInput = !0)),
          (e.formEventDelegate = (t) => {
            e.dispatch(t.type, t);
          }),
          OB.bind(s, 'submit reset', e.formEventDelegate),
          e.on('reset', () => {
            e.resetContent();
          }),
          !kc(e) ||
          ...
          (e.windowManager = OE(e)),
          (e.notificationManager = RE(e)),
          ((e) => 'xml' === e.options.get('encoding'))(e) &&
            e.on('GetContent', (e) => {
              e.save && (e.content = OB.encode(e.content));
            }),
          Nc(e) &&
            e.on('submit', () => {
    ...
    hasPlugin(e, t) {
      return !(!$(Pc(this), e) || (t && void 0 === DE.get(e)));
    }
    nodeChanged(e) {
    ...
    show() {
      ...
      e.hidden &&
        ...
        e.inline
          ...
          : (UP.show(e.getContainer()), UP.hide(e.id)),
        e.load(),
        e.dispatch('show'));
    }
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : (UP.hide(e.getContainer()),
            UP.setStyle(e.id, 'display', e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch('hide'));
    }
    isHidden() {
    ...
    getContent(e) {
      return ((e, t = {}) => {
        ...
        return YC(e, n).fold(A, (t) => {
          const n = ((e, t) => dE(e).editor.getContent(t))(e, t);
          return GC(e, n, t);
        });
      })(this, e);
    }
    ...
    resetContent(e) {
      (void 0 === e
        ? vE(this, this.startContent, { initial: !0, format: 'raw' })
        : vE(this, e, { initial: !0 }),
    ...
    getContainer() {
      ...
      return (
        e.container ||
          (e.container = e.editorContainer || UP.get(e.id + '_parent')),
        e.container
      );
    }
    ...
    getElement() {
      return (
        this.targetElm || (this.targetElm = UP.get(this.id)),
        this.targetElm
      );
    }
    getWin() {
        ...
        if (!e.removed) {
          ...
          (o && e.save({ is_removing: !0 }),
            ...
            !e.inline &&
              o &&
              ((e) => {
                yE.setStyle(e.id, 'display', e.orgDisplay);
              })(e),
            ((e) => {
              e.dispatch('detach');
            })(e),
            yE.remove(e.getContainer()),
            CE(t),
            CE(n),
            e.destroy());
        }
            ...
            ? (t ||
              ...
              ((e) => {
                ...
                t &&
                  ...
                  yE.unbind(t, 'submit reset', e.formEventDelegate));
              })(e),
              ((e) => {
                const t = e;
  ...
  const YP = (e) => {
    ...
    GP = (e) => {
      if (e !== WP) {
        const t = li.DOM;
        (e
          ? (t.bind(window, 'resize', YP), t.bind(window, 'scroll', YP))
          : (t.unbind(window, 'resize', YP), t.unbind(window, 'scroll', YP)),
          (WP = e));
      }
    },
    XP = (e) => {
      ...
      return (
        (KP = Y(KP, (t) => e !== t)),
        ZP.activeEditor === e &&
          (ZP.activeEditor = KP.length > 0 ? KP[0] : null),
        ZP.focusedEditor === e && (ZP.focusedEditor = null),
        t.length !== KP.length
      );
    },
    QP = 'CSS1Compat' !== document.compatMode,
    ZP = {
      ...bP,
      baseURI: null,
      baseURL: null,
      ...
      setup() {
        ...
        let t = '',
          n = '',
          o = AC.getDocumentBaseUrl(document.location);
        /^[^:]+:\/\/\/?[^\/]+\//.test(o) &&
          ((o = o.replace(/[\?#].*$/, '').replace(/[\/\\][^\/]+$/, '')),
          /[\/\\]$/.test(o) || (o += '/'));
        ...
        var s;
        ((e.baseURL = new AC(o).toAbsolute(t)),
          (e.documentBaseURL = o),
          (e.baseURI = new AC(e.baseURL)),
          (e.suffix = n),
        ...
        return (
          n === e ||
            ...
            qP ||
              ...
              window.addEventListener('beforeunload', qP))),
          e
        );
      },
      createEditor(e, t) {
        return this.add(new $P(e, t, this));
      },
      remove(e) {
        const t = this;
        let n;
        if (e) {
          if (!u(e))
            return (
              ...
              h(t.get(n.id))
                ? null
                : (XP(n) && t.dispatch('RemoveEditor', { editor: n }),
                  0 === KP.length &&
                    window.removeEventListener('beforeunload', qP),
                  n.remove(),
                  GP(KP.length > 0),
                  n)
            );
        ...
        } else for (let e = KP.length - 1; e >= 0; e--) t.remove(KP[e]);
      },
      execCommand(e, t, n) {
        var o;
        const r = this,
      ...
      _setBaseUrl(e) {
        ((this.baseURL = new AC(this.documentBaseURL).toAbsolute(
          e.replace(/\/+$/, '')
        )),
          (this.baseURI = new AC(this.baseURL)));
      },
      _addLicenseKeyManager: (e) => GE.add(e)
    };
  ZP.setup();
  const JP = (() => {
      const e = We();
    ...
    rL = (e, t, n, o) => ({ x: e, y: t, w: n, h: o }),
    sL = {
      inflate: (e, t, n) => rL(e.x - t, e.y - n, e.w + 2 * t, e.h + 2 * n),
      relativePosition: oL,
      ...
      intersect: (e, t) => {
        const n = tL(e.x, t.x),
          o = tL(e.y, t.y),
          r = eL(e.x + e.w, t.x + t.w),
          s = eL(e.y + e.h, t.y + t.h);
        return r - n < 0 || s - o < 0 ? null : rL(n, o, r - n, s - o);
      },
      clamp: (e, t, n) => {
        let o = e.x,
          r = e.y,
      ...
      create: rL,
      fromClientRect: (e) => rL(e.left, e.top, e.width, e.height)
    },
    aL = (() => {
      const e = {},
        t = {},
  ...
  const lL = {
      ...
      util: {
        ...
        ImageUploader: (e) => {
          const t = lx(),
            n = ux(e, t);
          return { upload: (t, o = !0) => n.upload(t, o ? mx(e) : void 0) };
        }
      },
      dom: {
        EventUtils: Za,
