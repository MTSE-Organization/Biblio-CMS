import { ORDER_DETAIL_STATUS_REFUNDED } from '@/constants';
import { useOrderStatusRatioQuery } from '@/queries';
import React from 'react';
import CountUp from 'react-countup';

export default function RefundOrderRatioCard() {
  ...
  const refundRatio = statusRatio?.find(
    (item) => item.status === ORDER_DETAIL_STATUS_REFUNDED
  );
