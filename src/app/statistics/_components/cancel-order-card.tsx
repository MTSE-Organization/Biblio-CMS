import { ORDER_DETAIL_STATUS_CANCELLED } from '@/constants';
import { useOrderStatusRatioQuery } from '@/queries';
import React from 'react';
import CountUp from 'react-countup';

export default function CancelOrderRatioCard() {
  ...
  const cancelRatio = statusRatio?.find(
    (item) => item.status === ORDER_DETAIL_STATUS_CANCELLED
  );
